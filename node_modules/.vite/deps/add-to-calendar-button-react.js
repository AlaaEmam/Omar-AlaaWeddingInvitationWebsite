...
function D(t, e, n) {
  ...
  const a = e + "T" + n + ":00", i = new Date(a), r = i.getFullYear(), l = i.getMonth() + 1, c = i.getDate(), s = i.getHours(), p = o[1].replace(/[^\w_\-:,;=+/<br>]/g, "").split("<br>"), b = { 1: {}, 2: {} };
  let x = 0;
  for (let u = 0; u < p.length; u++)
    if (p[`${u}`].startsWith("TZOFFSETTO") && (x++, b[`${x}`].offset = p[`${u}`].split(":")[1]), p[`${u}`].startsWith("DTSTART") && (b[`${x}`].hour = parseInt(p[`${u}`].substr(17, 2))), p[`${u}`].startsWith("RRULE")) {
      let T = p[`${u}`].split(";"), v = parseInt(T[1].split("=")[1]);
      b[`${x}`].month = parseInt(v), b[`${x}`].day = T[2].split("=")[1];
    }
  if (b[1].month > b[2].month && ([b[1], b[2]] = [b[2], b[1]]), l != b[1].month && l != b[2].month)
    return l < b[1].month || l > b[2].month ? b[2].offset : b[1].offset;
  const d = (function() {
    return Object.keys(b).find((u) => b[`${u}`].month == l);
  })(), h = ["SU", "MO", "TU", "WE", "TH", "FR", "SA"], A = new Date(r, l, 0).getDate();
  let g = new Date(r, l - 1, 1).getDay();
  const y = { SU: {}, MO: {}, TU: {}, WE: {}, TH: {}, FR: {}, SA: {} };
  for (let u = 1; u <= A; u++) {
    const T = Object.keys(y[h[`${g}`]]).length + 1;
    y[h[`${g}`]][`${T}`] = u, g++, g == 7 && (g = 0);
  }
  const f = (function() {
    if (b[`${d}`].day[0] == "-") {
      const u = b[`${d}`].day.substr(2, 2), T = Object.keys(y[`${u}`]).length + 1 - parseInt(b[`${d}`].day[1]);
      return y[`${u}`][`${T}`];
    } else {
      const u = b[`${d}`].day.substr(1, 2);
      return y[`${u}`][b[`${d}`].day[0]];
    }
  })();
  if (c > f || c == f && s >= b[`${d}`].hour)
    return b[`${d}`].offset;
  const L = (function() {
    return d == 1 ? 2 : 1;
  })();
...
var mt = [];
function de(t = false) {
  return mt.length == 0 && (mt = (function() {
    let e = [];
...
var B = U() ? () => !!(/iPad|iPhone|iPod/i.test(navigator.userAgent) && !/MSStream/i.test(navigator.userAgent)) : () => false;
var X = U() ? () => !!(/android/i.test(navigator.userAgent) && !/MSStream/i.test(navigator.userAgent)) : () => false;
var Nt = U() ? () => !!/^(?:(?!chrome|android|crios|fxios).)*safari/i.test(navigator.userAgent) : () => false;
var K = () => !!(X() || B());
var it = U() ? () => !!/; ?wv|(?:iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(navigator.userAgent) : () => false;
var Ne = U() ? () => !!/Instagram/i.test(navigator.userAgent) : () => false;
var Bt = it() ? "_system" : "_blank";
var Be = ["apple", "google", "ical", "ms365", "outlookcom", "msteams", "yahoo"];
var Me = ["apple", "google", "ical"];
var Re = ["msteams"];
var _e = ["ical"];
var Ue = ["apple"];
var C = [];
...
var Ze = ["customLabels", "ty", "rsvp", "customVar"];
var He = ["dates"];
var Fe = ["recurrence_byDay", "recurrence_byMonth", "recurrence_byMonthDay", "images", "options", "optionsMobile", "optionsIOS"];
var $e = ["sequence", "recurrence_interval", "recurrence_count"];
var W = {
...
async function Mt(t) {
  return t = Xe(t), t = je(t), t = Pe(t), t = qe(t), t = cn(t), t.sizes = sn(t.size), t.lightMode = dn(t.lightMode), t = bn(t), t = pe(t), t = await Tn(t), t;
}
function Xe(t) {
...
function Xt(t) {
  (!t.timeZone || t.timeZone === "") && (t.timeZone = "GMT"), (!t.status || t.status === "") && (t.status = "CONFIRMED"), !t.sequence || t.sequence === "" ? t.sequence = 0 : (t.sequence = parseInt(t.sequence), (isNaN(t.sequence) || t.sequence < 0) && (t.sequence = 0));
}
function je(t) {
  if (t.dates)
    ...
    Xt(t);
  return (!t.language || t.language === "" || !yo.includes(t.language)) && (t.language = "en"), t;
}
function Pe(t) {
  return t.recurrence && t.recurrence !== "" && (t = Qe(t), t = Ke(t)), t;
}
function Qe(t) {
  if (t.recurrence = t.recurrence.replace(/\s+/g, "").toUpperCase(), /^RRULE:/i.test(t.recurrence)) {
    t.recurrence_simplyfied = false;
    const e = Le(t.recurrence, false);
    t.recurrence_until = e.UNTIL, t.recurrence_count = e.COUNT, t.recurrence_byDay = e.BYDAY, t.recurrence_byMonth = e.BYMONTH, t.recurrence_byMonthDay = e.BYMONTHDAY, t.recurrence_interval = e.INTERVAL, t.recurrence_frequency = e.FREQ;
  } else
    t.recurrence_simplyfied = true, (!t.recurrence_interval || t.recurrence_interval === "") && (t.recurrence_interval = 1), (!t.recurrence_weekstart || t.recurrence_weekstart === "" | t.recurrence_weekstart.length > 2) && (t.recurrence_weekstart = "MO"), t.recurrence_frequency = t.recurrence, t.recurrence = "RRULE:FREQ=" + t.recurrence + ";WKST=" + t.recurrence_weekstart + ";INTERVAL=" + t.recurrence_interval, t.recurrence_until && t.recurrence_until !== "" && (t.recurrence_until = t.recurrence_until.replace(/[-:]/g, ""), t.recurrence_until.length < 9 && (t.recurrence_until += "T235959Z"), t.recurrence = t.recurrence + ";UNTIL=" + t.recurrence_until), t.recurrence_count && t.recurrence_count !== "" && (t.recurrence = t.recurrence + ";COUNT=" + t.recurrence_count), t.recurrence_byDay && t.recurrence_byDay !== "" && (t.recurrence = t.recurrence + ";BYDAY=" + t.recurrence_byDay), t.recurrence_byMonth && t.recurrence_byMonth !== "" && (t.recurrence = t.recurrence + ";BYMONTH=" + t.recurrence_byMonth), t.recurrence_byMonthDay && t.recurrence_byMonthDay !== "" && (t.recurrence = t.recurrence + ";BYMONTHDAY=" + t.recurrence_byMonthDay);
  return t;
}
function Ke(t) {
  const e = t.dates?.[0].startDate || t.startDate, n = t.dates?.[0].startTime || t.startTime, o = t.dates?.[0].endDate || t.endDate || e, a = t.dates?.[0].endTime || t.endTime || "", i = t.dates?.[0].timeZone || t.timeZone || "UTC", r = (function() {
    if (a && a !== "" && n && n !== "") {
      const y = n && n !== "" ? /* @__PURE__ */ new Date(`${e}T${n}:00${l(D(i, e, n))}`) : /* @__PURE__ */ new Date(`${e}T00:00:00${l(D(i, e, "00:00"))}`);
      return (a && a !== "" ? /* @__PURE__ */ new Date(`${o}T${a}:00${l(D(i, o, a))}`) : /* @__PURE__ */ new Date(`${o}T00:00:00${l(D(i, o, "00:00"))}`)).getTime() - y.getTime();
    }
    return 0;
  })();
  function l(y) {
    if (!y || y === "Z" || y === "+0000" || y === "-0000" || y === "+00:00" || y === "-00:00") return "Z";
    const f = String(y).replace(/^GMT/i, "");
    if (/^[+-]\d{2}:\d{2}$/.test(f)) return f;
    if (/^[+-]\d{4}$/.test(f)) return `${f.slice(0, 3)}:${f.slice(3)}`;
    const L = f.startsWith("-") ? "-" : "+", u = f.replace(/\D/g, "").padStart(4, "0").slice(0, 4);
    return `${L}${u.slice(0, 2)}:${u.slice(2)}`;
  }
  const c = n && n !== "" ? D(i, e, n) : "", s = (function() {
    if (n && n !== "") {
      const f = l(c);
      return /* @__PURE__ */ new Date(`${e}T${n}:00${f}`);
    }
    const y = l(D(i, e, "00:00"));
    return /* @__PURE__ */ new Date(`${e}T00:00:00${y}`);
  })(), p = !(n && n !== ""), b = ho(t.recurrence, s, r, p, i);
  if (!b || !b.nextOccurrence)
    return t;
  function x(y, f, L) {
    if (!(y instanceof Date) || !isFinite(y.getTime()))
      return { date: "", time: "" };
    try {
      const u = L ? { timeZone: f, hour12: false, hourCycle: "h23", year: "numeric", month: "2-digit", day: "2-digit", hour: "2-digit", minute: "2-digit" } : { timeZone: f, year: "numeric", month: "2-digit", day: "2-digit" }, T = new Intl.DateTimeFormat("en-CA", u).formatToParts(y), v = (k) => T.find((w) => w.type === k)?.value || "";
      return { date: `${v("year")}-${v("month")}-${v("day")}`, time: L ? `${v("hour")}:${v("minute")}` : "" };
    } catch {
      return { date: "", time: "" };
    }
  }
  const d = x(b.nextOccurrence, i, false).date;
  if (d)
    t.startDate = d, n && (t.startTime = n);
  else
    return t;
  const h = n ? /* @__PURE__ */ new Date(`${t.startDate}T${n}:00${l(D(i, t.startDate, n))}`) : /* @__PURE__ */ new Date(`${t.startDate}T00:00:00${l(D(i, t.startDate, "00:00"))}`), A = new Date(h.getTime() + r), g = x(A, i, !!(a && a !== ""));
  return g.date && (t.endDate = g.date, a && a !== "" && (t.endTime = g.time)), (t.recurrence_count && t.recurrence_count !== "" || t.recurrence_until && t.recurrence_until !== "") && (b.adjustedCount < 2 ? (t.recurrence = "", t.recurrence_frequency = "", t.recurrence_interval = "") : (t.recurrence_count = b.adjustedCount, t.recurrence = t.recurrence.replace(/;?COUNT=\d+/i, ";COUNT=" + t.recurrence_count), t.recurrence_until && t.recurrence_until !== "" && (t.recurrence_until = "", t.recurrence = t.recurrence.replace(/;?UNTIL=\w+/i, ";COUNT=" + t.recurrence_count), t.dates && t.dates[0].recurrence && (t.dates[0].recurrence = t.dates[0].recurrence.replace(/;?UNTIL=\w+/i, ";COUNT=" + t.recurrence_count))))), t;
}
function qe(t) {
  const { options: e, source: n } = Ge(t);
  let { newOptions: o, iCalGiven: a, appleGiven: i } = Ve(e, t);
  o = an(t, o), { newOptions: o, iCalGiven: a } = rn(o, a);
  const r = n !== "general" && (e.includes("ical") || e.includes("apple"));
  return o = ln(o, t, a, i, r), o.sort(), t.options = o, t;
}
function Ge(t) {
  let e = "general", n = t.options || ["ical"];
  return B() || t.fakeIOS ? (t.optionsIOS && t.optionsIOS.length > 0 && (e = "ios", n = t.optionsIOS), t.optionsMobile && t.optionsMobile.length > 0 && (e = "mobile", n = t.optionsMobile)) : (X() || t.fakeMobile || t.fakeAndroid) && t.optionsMobile && t.optionsMobile.length > 0 && (e = "mobile", n = t.optionsMobile), { options: n, source: e };
}
function Ve(t, e) {
  let n = [], o = false, a = false;
  for (let i = 0; i < t.length; i++) {
    const r = We(t[`${i}`]);
    r === "apple" && (a = true), r === "ical" && (o = true), !Je(r, e) && n.push(r);
  }
  return { newOptions: n, iCalGiven: o, appleGiven: a };
}
function We(t) {
  return t.split("|")[0].toLowerCase().replace("microsoft", "ms").replace(/\./, "");
}
function Je(t, e) {
  return tn(t, e) || en(t, e) || nn(t, e) || on(t, e);
}
function tn(t, e) {
  const n = (B() || e.fakeIOS) && _e.includes(t) && (!e.optionsIOS || e.optionsIOS.length === 0) && (!e.optionsMobile || e.optionsMobile.length === 0), o = (X() || e.fakeMobile || e.fakeAndroid) && Ue.includes(t) && (!e.optionsMobile || e.optionsMobile.length === 0);
  return n || o;
}
function en(t, e) {
  if (!e.recurrence || e.recurrence === "") return false;
  const n = !Me.includes(t), o = (B() || e.fakeIOS) && t === "google";
  return n || o;
}
function nn(t, e) {
  return e.subscribe && Re.includes(t);
}
function on(t, e) {
  return (K() || e.fakeMobile) && e.subscribe && (t === "ms365" || t === "outlookcom");
}
function an(t, e) {
  return t.subscribe && t.icsFile && t.icsFile.startsWith("https://calendar.google.com/calendar/") && !t.icsFile.endsWith(".ics") ? ["google"] : e;
}
function rn(t, e) {
  return t.length === 0 && (t.push("ical"), e = true), { newOptions: t, iCalGiven: e };
}
function ln(t, e, n, o, a = false) {
  return a || ((B() || e.fakeIOS) && n && !o ? (t.push("apple"), t = t.filter((i) => i !== "ical")) : (X() || e.fakeMobile || e.fakeAndroid) && o && !n && (t.push("ical"), t = t.filter((i) => i !== "apple"))), t;
}
function cn(t) {
  return t.inlineRSVP && (t.inline = true), (!t.listStyle || t.listStyle === "") && (t.listStyle = "dropdown"), t.listStyle === "modal" && (t.trigger = "click"), t.buttonStyle && t.buttonStyle !== "" && t.buttonStyle != "default" ? (t.buttonStyle == "simple" || t.buttonStyle == "round" || t.buttonStyle == "text" || t.buttonStyle == "date" || t.buttonStyle == "neumorphism") && (t.trigger = "click") : t.buttonStyle = "default", (t.buttonStyle == "default" || t.buttonStyle == "3d" || t.buttonStyle == "flat") && !t.hideTextLabelList && t.hideTextLabelButton && (t.listStyle == "dropdown" || t.listStyle == "dropdown-static" || t.listStyle == "dropup-static") && (t.listStyle = "overlay"), t.buttonsList && t.buttonStyle == "date" && (t.buttonsList = false), t;
}
function sn(t) {
  const e = [];
...
function dn(t = "") {
  return t == "system" && U() ? window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light" : t != "bodyScheme" && t != "dark" ? "light" : t;
}
function bn(t) {
  return t.language.length > 2 && (t.language = t.language.substring(0, 2)), xo.includes(t.language) ? t.rtl = true : t.rtl = false, t;
}
function pe(t) {
  (!t.dates || !Array.isArray(t.dates)) && (t.dates = [{ name: t.name }]), t.recurrence && t.recurrence !== "" && (t.dates[0].recurrence = t.recurrence);
  for (let n = 0; n < t.dates.length; n++)
    t = pn(t, n), t = un(t, n), t = mn(t, n), t = fn(t, n), t = hn(t, n), t = vn(t, n), t = gn(t, n);
  t = wn(t);
  const e = /* @__PURE__ */ new Date();
  return (!t.created || t.created === "") && (t.created = S(e, "clean", true)), (!t.updated || t.updated === "") && (t.updated = S(e, "clean", true)), t.dates.length > 1 && t.dates.sort((n, o) => n.timestamp - o.timestamp), t;
}
function pn(t, e) {
  const n = t.dates[`${e}`], o = ["description", "startDate", "startTime", "endDate", "endTime", "timeZone", "useUserTZ", "location", "status", "sequence", "availability", "organizer", "attendee"];
  return t.dates.length === 1 && o.unshift("name"), o.forEach((a) => {
    (t[`${a}`] && t[`${a}`] !== "" || a === "sequence" && t[`${a}`] === 0) && (n[`${a}`] = t[`${a}`]);
  }), t;
}
function un(t, e) {
  const n = t.dates[`${e}`], o = xn(n);
  return n.startDate = o.startDate, n.endDate = o.endDate, n.startTime = o.startTime, n.endTime = o.endTime, n.timeZone = o.timeZone, n.timestamp = Pt("timestamp", n.startDate, n.startTime, n.timeZone), n.overdue = Pt("overdue", n.endDate, n.endTime, n.timeZone), t;
}
function mn(t, e) {
  const n = t.dates[`${e}`];
  return n.uid || (e === 0 && t.uid && t.uid !== "" ? n.uid = t.uid : t.uid && t.uid !== "" ? n.uid = `${t.uid}-${e + 1}` : n.uid = Ae()), t;
}
function fn(t, e) {
  const n = t.dates[`${e}`];
  return n.status = ae(n.status, "upper"), n.availability = ae(n.availability, "lower"), t;
}
function hn(t, e) {
  const n = (a) => a.replace(/(\\r\\n|\\n|\\r|<br(\s*\/?)>)/g, "");
  let o = t.dates[`${e}`].description;
  if (o) {
    o = n(o);
    const a = tt(o, true), i = tt(o, true, true);
    o = tt(o), t.dates[`${e}`] = { ...t.dates[`${e}`], description: o, descriptionHtmlFree: a, descriptionHtmlFreeICal: i };
  } else
...
function gn(t, e) {
  const n = t.dates[`${e}`];
  return n.location && n.location.startsWith("http") ? n.onlineEvent = true : n.onlineEvent = false, t;
}
function vn(t, e) {
  if (!t.customVar) return t;
  const n = t.dates[`${e}`];
  for (const o in t.customVar) {
    const a = t.customVar[`${o}`];
    n.name = jt(n.name, o, a), n.location = jt(n.location, o, a);
  }
  return t;
}
function jt(t, e, n) {
  const o = "%%" + e.replace(/[^\w\-.]/g, "") + "%%";
  return t && t.replace(new RegExp(o, "gi"), n);
}
function xn(t) {
  function e(a) {
    return /^\d\d\d\d-\d\d-\d\d(?:T\d\d:\d\d)?(?::\d\d)?(?:.\d\d\d)?Z?(?:\+(?:\d|\d\d|\d\d\d|\d\d\d\d))?$/i.test(a);
  }
  function n(a) {
  ...
  if ((!t.endDate || t.endDate === "") && (t.endDate = t.startDate), ["start", "end"].forEach(function(a) {
    ...
    if (!e(i) && !n(i))
      ...
      if ((/\+/.test(i) || n(i)) && (t[a + "Date"] = yn(i)), t[a + "Date"]) {
        const r = t[a + "Date"].split("T");
        r[1] && (t[a + "Date"] = r[0], t[a + "Time"] = r[1]);
      }
      t[a + "Time"] && t[a + "Time"].length > 5 && (t[a + "Time"] = t[a + "Time"].substring(0, 5));
    }
  }), t.timeZone === "currentBrowser" || t.useUserTZ) {
    let a = Intl.DateTimeFormat().resolvedOptions().timeZone || "GMT";
    if (de().includes(a) || (a = go(a)), t.useUserTZ && t.startTime && t.startTime !== "" && t.endTime && t.endTime !== "") {
      const r = ee(t.startDate, t.startTime, t.timeZone, a), l = ee(t.endDate, t.endTime, t.timeZone, a);
      t.startDate = r[0], t.startTime = r[1], t.endDate = l[0], t.endTime = l[1];
    }
    t.timeZone = a;
  }
  return t;
}
function Pt(t, e, n = null, o) {
  try {
    const a = (function() {
      if (n) {
        const r = D(o, e, n);
        return /* @__PURE__ */ new Date(e + " " + n + ":00 GMT" + r);
      }
      return new Date(e);
    })();
    if (t === "timestamp")
    ...
    return a.getTime() < new Date(i).getTime();
  } catch {
    return false;
  }
}
function yn(t) {
  ...
  const o = t.split("+"), a = o[0].split("-"), i = new Date(Date.UTC(a[0], a[1] - 1, a[2].substring(0, 2)));
  o[1] && o[1] > 0 && i.setDate(i.getDate() + parseInt(o[1]));
  try {
...
function wn(t) {
  if ((!t.pastDateHandling || t.pastDateHandling !== "disable" && t.pastDateHandling !== "hide") && (t.pastDateHandling = "none"), t.allOverdue = (function() {
    for (let e = 0; e < t.dates.length; e++)
      if (!t.dates[`${e}`].overdue)
        return false;
    return true;
  })(), t.allOverdue)
    t.pastDateHandling === "disable" ? t.disabled = true : t.pastDateHandling === "hide" && (t.hidden = true);
  else if (t.pastDateHandling === "hide" && t.dates.length > 1) {
    const e = [];
    for (let n = 0; n < t.dates.length; n++)
      t.dates[`${n}`].overdue || e.push(t.dates[`${n}`]);
    t.dates = e;
  }
  return t.allCancelled = (function() {
    for (let e = 0; e < t.dates.length; e++)
      if (!t.dates[`${e}`].status || t.dates[`${e}`].status.toLowerCase() !== "cancelled")
        return false;
    return true;
  })(), (t.disabled || t.hidden) && (t.blockInteraction = true), t;
}
async function Tn(t) {
  ...
  if (t.rsvp.expired = (function() {
    ...
    t.rsvp.seatsLeft = t.rsvp.max - e, t.rsvp.seatsLeft < 1 && (t.rsvp.bookedOut = true), (t.rsvp.expired || t.rsvp.bookedOut) && (t.blockInteraction = true), t.blockInteraction && (t.disabled = true);
  }
  return t;
}
async function Ot(t) {
  ...
  if (t.dates && t.dates.length > 0) {
    if (t.subscribe === true && t.dates.length > 1)
...
async function ue(t) {
  ...
  try {
    return await me(t, e), await kn(t, e), await An(t, e), await Ln(t, e), await Cn(t, e), await Yn(t, e), await zn(t, e), await Rn(t, e), t.recurrence_simplyfied && await _n(t, e), true;
  } catch (n) {
    throw new Error(n.message);
  }
}
async function me(t, e, n = "", o = "") {
  const a = (function() {
    return n !== "" && t.dates[`${n}`].icsFile ? t.dates[`${n}`].icsFile : n === "" && t.icsFile ? t.icsFile : "";
  })();
  if (a !== "" && (!nt(a, false) || !t.icsFile.startsWith("https://") && !t.icsFile.startsWith("http://")))
...
async function kn(t, e) {
  ...
  if (t.customCss && t.customCss !== "" && (!nt(t.customCss, false) || !/\.css(?:$|\?)/.test(t.customCss)))
...
async function An(t, e) {
  if (t.subscribe === true && (!t.icsFile || t.icsFile === ""))
...
async function zn(t, e) {
  try {
    for (let n = 0; n < t.dates.length; n++) {
      ...
      await me(t, e, n, o), await En(t, e, n, o), await On(t, e, n, o), await In(t, e, n, o), await Sn(t, e, n, o), await Dn(t, e, n, o), await Nn(t, e, n, o), await Bn(t, e, n, o), await Mn(t, e, n, o);
    }
    return true;
  } catch (n) {
    throw new Error(n.message);
...
async function Dn(t, e, n, o) {
  return /^(?:\w|-){1,254}$/.test(t.dates[`${n}`].uid) || (t.debug && console.warn(e + ": UID not valid. May only contain alpha, digits, and dashes; and be less than 255 characters. Falling back to an automated value!" + o), t.dates[`${n}`].uid = Ae()), !/^[0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(t.dates[`${n}`].uid) && t.debug && console.warn(e + ": UID is highly recommended to be a hex-encoded random Universally Unique Identifier (UUID)!" + o), true;
}
async function Nn(t, e, n, o) {
  return t.dates[`${n}`].sequence && (t.dates[`${n}`].sequence < 0 || t.dates[`${n}`].sequence % 1 !== 0) && (t.debug && console.log(e + ": sequence needs to be a full number >= 0. Used the default 0 instead" + o), t.dates[`${n}`].sequence = 0), true;
}
async function Bn(t, e, n, o) {
  if (!de().includes(t.dates[`${n}`].timeZone))
    throw new Error(e + " failed: invalid time zone given" + o);
  return true;
}
async function Mn(t, e, n, o) {
  const a = t.dates[`${n}`], i = ["startDate", "endDate"], r = {};
  if (i.forEach((c) => {
    const s = a[`${c}`];
    if (s.length !== 10)
    ...
    if (s) {
      ...
      const p = s.split(":");
      if (p.length !== 2 || p[0] > 23 || p[1] > 59)
        throw new Error(`${e} failed: time misspelled [${c}: ${s}]${o}`);
      const b = c === "startTime" ? "startDate" : "endDate";
      r[`${b}`] = new Date(r[`${b}`].getTime() + parseInt(p[0], 10) * 36e5 + parseInt(p[1], 10) * 6e4);
    }
...
async function _n(t, e) {
  ...
  if (t.recurrence_until && t.recurrence_until !== "" && !/^\d{8}T\d{6}Z$/.test(t.recurrence_until))
    throw new Error(e + " failed: recurrence data (until) misspelled - must be in format YYYYMMDDTHHMMSSZ");
  if (t.recurrence_count && (t.recurrence_count < 1 || t.recurrence_count % 1 !== 0))
    throw new Error(e + " failed: recurrence data (count) misspelled");
...
function E(t, e, n = "", o = null, a = false, i = false) {
  e == "open" ? Qt(t, n, o, a, i) : e == "close" || o.classList.contains("atcb-active") || t.querySelector(".atcb-active-modal") ? J(t, a) : Qt(t, n, o, a, i);
}
async function Qt(t, e, n = null, o = false, a = false) {
  if (t.querySelector(".atcb-list") || t.querySelector(".atcb-modal")) return;
  z("openList", e.identifier, e.identifier), C.active = e.identifier;
  const i = Fn(t, e), r = document.createElement("div");
  r.classList.add("atcb-list-wrapper"), r.setAttribute("part", "atcb-list-wrapper"), e.hideTextLabelList && r.classList.add("atcb-no-text"), n ? (n.classList.add("atcb-active"), n.setAttribute("aria-expanded", true), e.listStyle === "modal" ? (n.classList.add("atcb-modal-style"), i.classList.add("atcb-modal")) : (r.append(i), r.classList.add("atcb-dropdown"), e.listStyle === "overlay" && r.classList.add("atcb-dropoverlay")), a && i.classList.add("atcb-generated-button")) : i.classList.add("atcb-modal");
  const l = xe(t, e.trigger, e.listStyle === "modal", !e.hideBackground);
  if (e.listStyle === "modal") {
    const s = await dt(t, e);
    s.querySelector(".atcb-modal-host-initialized").append(l), l.append(i), e.hideBranding || ct(s, false), st(i, e.sizes), Rt(s), q(l);
  } else
    e.forceOverlay && (t = await $n(t, e), n = t.querySelector("button.atcb-button")), t.querySelector(".atcb-initialized").append(r), r.append(i), e.buttonStyle != "default" && r.classList.add("atcb-style-" + e.buttonStyle), e.hideBranding || ct(t), t.append(l), st(i, e.sizes), r.style.display = "none", setTimeout(function() {
      r.style.display = "block", e.listStyle === "dropdown-static" ? Ct(t, n, r, true) : e.listStyle === "dropup-static" ? Ct(t, n, r, false, true) : Ct(t, n, r);
    }, 5), q(l);
  const c = (function() {
    const s = t.querySelector(".atcb-list-item");
    if (s)
      return s;
    const p = document.getElementById(e.identifier + "-modal-host");
    if (p)
      return p.shadowRoot.querySelector(".atcb-list-item");
  })();
  c && (o ? c.focus() : (c.focus({ preventScroll: true }), c.blur()));
}
function J(t, e = false) {
  ...
  if (o.length > 1) {
    ...
    let i = a;
    const r = a.getElementsByTagName("button");
    r.length > 0 && (i = r[0]), i.focus(), e || i.blur();
  } else {
    const a = (function() {
      const r = t.querySelector(".atcb-active, .atcb-active-modal");
      return r || document.querySelector(".atcb-active, .atcb-active-modal");
    })();
    a && (a.focus({ preventScroll: true }), e || a.blur()), Array.from(t.querySelectorAll(".atcb-active")).forEach((r) => {
      r.classList.remove("atcb-active"), r.setAttribute("aria-expanded", false);
    }), Array.from(t.querySelectorAll(".atcb-active-modal")).forEach((r) => {
      r.classList.remove("atcb-active-modal");
    }), Array.from(document.querySelectorAll(".atcb-active")).forEach((r) => {
      r.classList.remove("atcb-active"), r.setAttribute("aria-expanded", false);
    }), Array.from(document.querySelectorAll(".atcb-active-modal")).forEach((r) => {
      r.classList.remove("atcb-active-modal");
    }), n && n.remove(), document.body.classList.remove("atcb-modal-no-scroll"), document.documentElement.classList.remove("atcb-modal-no-scroll"), Array.from(t.querySelectorAll(".atcb-list-wrapper")).concat(Array.from(t.querySelectorAll(".atcb-list"))).concat(Array.from(t.querySelectorAll("#atcb-reference"))).concat(Array.from(t.querySelectorAll("#atcb-bgoverlay"))).forEach((r) => r.remove());
    const i = document.querySelector(".atcb-shadow-hide");
    i && (i.shadowRoot.querySelector(".atcb-initialized").style.opacity = "1", i.classList.remove("atcb-shadow-hide"), window.removeEventListener("scroll", vt), window.removeEventListener("resize", vt)), C.active = "";
  }
}
async function Kt(t, e) {
  let n = t, o = e;
  t.host || (n = n.shadowRoot, o = await Mt(o));
  const a = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 7.5V6.108c0-1.135.845-2.098 1.976-2.192.373-.03.748-.057 1.123-.08M15.75 18H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08M15.75 18.75v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 006.375 7.5H5.25m11.9-3.664A2.251 2.251 0 0015 2.25h-1.5a2.251 2.251 0 00-2.15 1.586m5.8 0c.065.21.1.433.1.664v.75h-6V4.5c0-.231.035-.454.1-.664M6.75 7.5H4.875c-.621 0-1.125.504-1.125 1.125v12c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V16.5a9 9 0 00-9-9z" /></svg>', i = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M11.35 3.836c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75 2.25 2.25 0 00-.1-.664m-5.8 0A2.251 2.251 0 0113.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m8.9-4.414c.376.023.75.05 1.124.08 1.131.094 1.976 1.057 1.976 2.192V16.5A2.25 2.25 0 0118 18.75h-2.25m-7.5-10.5H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V18.75m-7.5-10.5h6.375c.621 0 1.125.504 1.125 1.125v9.375m-8.25-3l1.5 1.5 3-3.75" /></svg>', r = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>';
  if ((!o.proKey || o.proKey === "") && !window.location.hostname.match(/^(localhost|.*\.add-to-calendar-pro.com)$/))
    return;
  const l = await dt(n, o);
  q(l.querySelector(".atcb-modal-host-initialized"));
  const c = o.ty;
  (c.type === "link" || c.type === "form") && (!c.url || c.url === "" || !c.url.startsWith("http")) && (c.type = "text"), (!c.headline || c.headline === "") && (c.headline = m("thankyou", o) + "!");
  let s = '<div class="pro"><p id="ty-success-msg">' + m("form.success", o) + '</p><div id="ty-content">';
  c.text && c.text !== "" && (s += tt(c.text)), c.type === "share" && (s += `<p class="pro-pt pro-share-buttons">
  ...
  let p = {};
  if (c.type === "form") {
    const b = !c.text || c.text === "" || c.text === void 0, x = (function() {
      return c.button_label && c.button_label !== "" ? c.button_label : m("submit", o);
    })();
    if (s += '<form id="' + o.identifier + '-ty-form" class="pro-form' + (b ? " no-intro" : "") + '">', c.fields && c.fields.length > 0) {
      const d = c.fields.find((A) => A.name === "header" && A.type === "hidden");
      if (d && d.default && d.default !== "" && d.default.startsWith("{"))
        try {
          p = JSON.parse(d.default), Object.keys(p).length === 0 && (p.atcb = true), c.fields = c.fields.filter((A) => A.name !== "header");
        } catch {
        }
      const h = fe(c.fields, o.identifier + "-ty");
      c.fields = h.fields, s += h.html;
    }
  ...
  if (c.type === "link") {
    const b = (function() {
      return c.button_label && c.button_label !== "" ? c.button_label : m("continue", o);
    })();
    s += '<p class="pro-pt"><a href="' + c.url + '" target="_blank" rel="noopener" class="atcb-modal-btn atcb-modal-btn-primary atcb-modal-btn-border">' + b + "</a></p>";
  }
  if (s += "</div></div>", await F(l, o, "checkmark", c.headline, s), c.type === "share") {
    const b = l.getElementById("atcb-ty-share-copy");
    b.addEventListener("click", async function() {
      try {
        await yt(c.url), b.innerHTML = i + m("label.share.copied", o) + "!", setTimeout(function() {
          b.innerHTML = a + m("label.share.copy", o);
        }, 3e3);
      } catch (x) {
        console.error("Error copying to clipboard:", x);
      }
    }), b.addEventListener("keyup", function(x) {
      x.key === "Enter" && (x.preventDefault(), b.click());
    });
  }
  if (c.type === "form") {
    const b = l.getElementById(o.identifier + "-ty-form"), x = l.getElementById("submit-error"), d = l.getElementById("pro-form-submit"), h = l.getElementById("pro-form-submitting");
    d.addEventListener("click", async function(A) {
      A.preventDefault(), h.style.display = "block", d.style.display = "none";
      let g = he(l, c.fields);
      if (g || (x.textContent = m("form.error.required", o) + "."), g) {
        const y = [];
        let f = false;
        if (c.fields.forEach((u) => {
          u.type !== "label" && (u.type === "radio" ? f || (l.querySelectorAll('[name="' + u.name + '"]').forEach(function(v) {
            v.checked && y.push({ name: u.name, value: v.value });
          }), f = true) : u.type === "checkbox" ? (y.push({ name: u.name, value: l.getElementById(u.fieldId).checked }), f = false) : (y.push({ name: u.name, value: l.getElementById(u.fieldId).value }), f = false));
        }), await ge(c.url, y, p) === true) {
          l.getElementById("ty-success-msg").style.display = "block", l.getElementById("ty-content").style.display = "none";
          return;
        }
        x.textContent = m("form.error.sending", o) + ".";
      }
      b.classList.add("form-error"), h.style.display = "none", d.style.display = "block";
    }), d.addEventListener("keyup", function(A) {
      A.key === "Enter" && (A.preventDefault(), d.click());
    });
  }
}
async function R(t, e, n, o = false) {
  const a = e.rsvp, i = !a.text || a.text === "" || a.text === void 0, r = !a.headline || a.headline === "" || a.headline === void 0;
  let l = "", c = '<div class="pro">';
  const s = localStorage.getItem(e.proKey + "-rsvp-sent") === "true" || null;
  s && (c += '<div id="rsvp-sent-content">', c += "<p>" + m("form.success.already", e) + "</p>", e.hideButton || (c += '<div id="rsvp-atcb"></div>'), e.inlineRsvp && (c += '<button id="pro-form-restart" ' + (e.disabled && "disabled") + ' class="atcb-modal-btn atcb-modal-btn btn-small atcb-modal-btn-border">' + m("label.rsvp.restart", e) + "</button>"), c += "</div>"), c += '<div id="rsvp-success-msg"><p>' + m("form.success.sent", e) + '</p><p id="rsvp-success-msg-email">' + m("form.success.email", e) + '</p><p id="rsvp-success-msg-doi">' + m("form.success.doi", e) + "</p></div>", c += '<div id="rsvp-success-msg-demo">' + m("form.success.demo", e) + "</div>", c += '<div id="rsvp-content">', a.text && a.text !== "" && (c += tt(a.text)), c += '<form id="' + e.identifier + '-rsvp-form" class="pro-form' + (i ? " no-intro" : "") + (r ? " no-headline" : "") + '">';
  const p = e.proKey || "demo-rsvp";
  a.initial_confirmation === false ? (c += '<div id="rsvp-status-group">', c += "<p>" + m("form.status", e) + "</p>", c += '<div class="pro-field pro-field-type-radio"><div><input type="radio" name="' + p + '-status" id="' + e.identifier + '-rsvp-status-confirmed" aria-label="' + m("form.status.confirmed", e) + '" checked value="confirmed" ' + (e.disabled && "disabled") + ' /><label for="' + e.identifier + '-rsvp-status-confirmed" class="status-confirmed"><span>' + m("form.status.confirmed", e) + "</span></label></div>", a.maybe_option === true && (c += '<div><input type="radio" name="' + p + '-status" id="' + e.identifier + '-rsvp-status-undecided" aria-label="' + m("form.status.undecided", e) + '" value="undecided" ' + (e.disabled && "disabled") + ' /><label for="' + e.identifier + '-rsvp-status-undecided" class="status-undecided"><span>' + m("form.status.undecided", e) + "</span></label></div>"), c += '<div><input type="radio" name="' + p + '-status" id="' + e.identifier + '-rsvp-status-declined" aria-label="' + m("form.status.declined", e) + '" value="declined" ' + (e.disabled && "disabled") + ' /><label for="' + e.identifier + '-rsvp-status-declined" class="status-declined"><span>' + m("form.status.declined", e) + "</span></label></div></div>", c += "</div>") : l += '<input type="hidden" name="' + p + '-status" id="' + e.identifier + '-rsvp-status-confirmed" value="confirmed" />';
  const b = a.maxpp || 1;
  b === 1 ? l += '<input type="hidden" name="' + p + '-amount" id="' + e.identifier + '-rsvp-amount" value="1" />' : (c += '<div class="pro-field"><label for="' + e.identifier + '-rsvp-amount">' + m("form.amount", e) + " (" + m("form.max", e) + " " + b + ")<span>*</span></label>", c += '<input type="number" name="' + p + '-amount" min="1" max="' + b + '" id="' + e.identifier + '-rsvp-amount" ' + (e.disabled && "disabled") + ' aria-label="' + m("form.amount", e) + '" value="1" /></div>');
  const x = (function() {
    if (e.attendee && e.attendee !== "") {
      const k = e.attendee.split("|");
      return k.length > 1 ? k[1] : k[0];
    }
    return null;
  })(), d = a.fields?.find((k) => k.name === "email");
  if (d ? a.fields = a.fields.map((k) => k.name === "email" ? { ...k, required: true, type: "email", default: x !== "" ? x : k.default } : k) : x ? l += '<input type="hidden" name="email" id="' + e.identifier + '-rsvp-email" value="' + x + '" />' : (c += '<div class="pro-field"><label for="' + e.identifier + '-rsvp-email">' + m("form.email", e) + "<span>*</span></label>", c += '<input type="email" name="email" id="' + e.identifier + '-rsvp-email" ' + (e.disabled && "disabled") + ' aria-label="' + m("form.email", e) + '" value="" /></div>'), a.fields && a.fields.length > 0) {
    const k = fe(a.fields, e.identifier + "-rsvp", e.disabled);
    a.fields = k.fields, c += k.html;
  }
  c += l, c += '<p id="submit-error"></p>', c += '<p class="pro-pt"><button type="submit" id="pro-form-submit" ' + (e.disabled && "disabled") + ' class="atcb-modal-btn atcb-modal-btn-primary atcb-modal-btn-border">' + m("submit", e) + '</button><span id="pro-form-submitting" class="pro-waiting"><span>.</span><span>.</span><span>.</span></span></p>', a.seatsLeft && a.seatsLeft > 0 && (c += '<p class="pro-form-fine">' + m("form.seatsleft", e) + ": <b>" + a.seatsLeft + "</b></p>"), c += "</form>", c += "</div></div>";
  let h = null;
  if (!e.inlineRsvp)
    h = await dt(t, e), q(h.querySelector(".atcb-modal-host-initialized")), await F(
      h,
      e,
      void 0,
      a.headline,
      c,
      [
        { type: "none", label: m("label.rsvp.restart", e), small: true, primary: true, id: "pro-form-restart" },
        { type: "close", label: m("close", e), small: true, id: "modal-btn-close" },
        { type: "close", label: m("cancel", e), small: true, id: "modal-btn-cancel" }
      ],
      [],
      o,
      {},
    ...
    if (k.classList.add("atcb-modal-box", "rsvp-inline-wrapper"), k.setAttribute("part", "atcb-modal-box"), e.rtl && k.classList.add("atcb-rtl"), n.append(k), a.headline) {
      const O = document.createElement("div");
      O.classList.add("atcb-modal-headline"), k.append(O), O.innerHTML = a.headline;
    }
    const w = document.createElement("div");
    if (w.classList.add("atcb-modal-content"), k.append(w), !e.hideBranding) {
      const O = ct(h, false, true);
      k.append(O);
    }
    if (a.expired) {
      w.innerHTML = '<div class="pro"><p>' + m("label.rsvp.expired", e) + "</p></div>";
      return;
    } else if (a.bookedOut) {
      w.innerHTML = '<div class="pro"><p>' + m("label.rsvp.bookedout", e) + "</p></div>";
      return;
    } else
      w.innerHTML = c;
  }
  s && (h.getElementById("rsvp-content").style.display = "none");
  const A = h.getElementById("modal-btn-close"), g = h.getElementById("modal-btn-cancel"), y = h.getElementById("pro-form-restart");
  if (z("openRSVP", e.identifier, e.identifier), e.debug && console.log('RSVP form for "' + e.identifier + '" created'), s) {
    g && (g.style.display = "none");
    const k = h.getElementById("rsvp-atcb");
    if (k && !e.hideButton) {
      const w = JSON.parse(JSON.stringify(e));
      w.hideTextLabelButton = true, w.hideIconButton = false, w.buttonsList = true, ve(t, k, w);
    }
  } else
    A && (A.style.display = "none"), y && (y.style.display = "none");
  const f = h.getElementById(e.identifier + "-rsvp-form"), L = h.getElementById("submit-error"), u = h.getElementById("pro-form-submit"), T = h.getElementById("pro-form-submitting"), v = h.getElementById("pro-form-restart");
  u && (u.addEventListener("click", async function(k) {
    k.preventDefault(), T.style.display = "block", u.style.display = "none";
    const w = [{ type: "number", name: e.proKey + "-amount", fieldId: e.identifier + "-rsvp-amount", required: true }];
    d || w.push({ type: "email", name: "email", fieldId: e.identifier + "-rsvp-email", required: true });
    const O = Array.isArray(a.fields) ? a.fields : [];
    let j = he(h, [...w, ...O]);
    const Ut = h.getElementById(e.identifier + "-rsvp-amount"), kt = parseInt(Ut.value) || 1;
    if (a.maxpp && a.maxpp > 0 && kt > a.maxpp && (Ut.classList.add("error"), j = false), j || (L.textContent = m("form.error.required", e) + "."), j) {
      if (!e.proKey || e.proKey === "") {
        h.getElementById("rsvp-success-msg-demo").style.display = "block", h.getElementById("rsvp-content").style.display = "none", z("successRSVP", e.identifier, e.identifier), g && (g.style.display = "none"), A && (A.style.display = "block");
        return;
      }
      let bt = a.fields ? JSON.parse(JSON.stringify(a.fields)) : [];
      const H = [];
      H.push({ name: "prokey", value: e.proKey }), H.push({ name: "language", value: e.language });
      const Zt = h.querySelector('[name="' + e.proKey + '-status"]:checked');
      if (H.push({ name: "status", value: Zt ? Zt.value : "confirmed" }), H.push({ name: "amount", value: kt }), !d)
        H.push({ name: "email", value: h.getElementById(e.identifier + "-rsvp-email").value });
      else {
        const N = bt.find((ut) => ut.name === "email")?.fieldId;
        H.push({ name: "email", value: h.getElementById(N).value }), bt = bt.filter((ut) => ut.fieldId !== N);
      }
      const ot = {};
      let pt = false;
      bt.forEach((N) => {
        N.type !== "label" && (N.type === "radio" ? pt || (h.querySelectorAll('[name="' + N.name + '"]').forEach(function(Ht) {
          Ht.checked && (ot[N.name] = Ht.value);
        }), pt = true) : N.type === "checkbox" ? (ot[N.name] = h.getElementById(N.fieldId).checked, pt = false) : (ot[N.name] = h.getElementById(N.fieldId).value, pt = false));
      }), Object.keys(ot).length > 0 && H.push({ name: "payload", value: ot });
      const Z = await ge(`https://api${e.dev ? "-dev" : ""}.add-to-calendar-pro.com/24586219-9910-41fe-9b59-df53de9db7af`, H, { rsvp: true });
      if (Z === "doi" || Z === true) {
      ...
      Z.error && Z.error === 2 ? L.textContent = m("form.error.email", e) + "." : Z.error && Z.error === 5 ? L.textContent = m("label.rsvp.expired", e) + "." : Z.error && Z.error === 6 ? kt > 1 ? L.textContent = m("form.error.bookedoutmany", e) + "." : L.textContent = m("label.rsvp.bookedout", e) + "." : L.textContent = m("form.error.sending", e) + ".";
    }
    f.classList.add("form-error"), T.style.display = "none", u.style.display = "block";
  }), u.addEventListener("keyup", function(k) {
    k.key === "Enter" && (k.preventDefault(), u.click());
  })), v && (v.addEventListener("click", function(k) {
    k.preventDefault(), h.getElementById("rsvp-sent-content").style.display = "none", h.getElementById("rsvp-content").style.display = "block", A && (A.style.display = "none"), y && (y.style.display = "none"), g && (g.style.display = "block");
  }), v.addEventListener("keyup", function(k) {
    k.key === "Enter" && (k.preventDefault(), v.click());
  }));
}
async function Un(t, e) {
  const n = t.querySelector(".atcb-initialized"), o = document.createElement("div");
  o.classList.add("atcb-button-wrapper"), e.rtl && o.classList.add("atcb-rtl"), n.append(o), st(o, e.sizes);
  const a = document.createElement("button");
  a.classList.add("atcb-button", "atcb-click", "atcb-single"), e.disabled && a.setAttribute("disabled", true), e.hideTextLabelButton && a.classList.add("atcb-no-text"), a.type = "button", a.setAttribute("aria-expanded", false), o.append(a);
  const i = (function() {
    return e.rsvp.expired ? m("label.rsvp.expired", e) : e.rsvp.bookedOut ? m("label.rsvp.bookedout", e) : m("label.rsvp", e);
  })();
  return lt(t, e, a, "rsvp", !e.hideIconButton, i, true), e.debug && console.log('Add to Calendar RSVP Button "' + e.identifier + '" created'), true;
}
async function qt(t, e = false) {
  try {
...
function fe(t, e = "", n = false) {
  let o = "", a = "", i = 0, r = "", l = false;
  for (let c = 1; c <= t.length; c++) {
    ...
    (r === "radio" && s.type !== "radio" || r !== "radio") && (i = c), t[c - 1].fieldId = e + "-" + c;
    const p = s.type === "radio" ? s.placeholder || "" : s.default || "", b = s.label || "", x = s.type === "radio" ? "" : s.placeholder || "";
    let d = "";
    r !== "hidden" && c === i && c !== 1 && !l && (d += "</div>"), s.type !== "hidden" && c === i && (d += '<div class="pro-field pro-field-type-' + s.type + '">'), s.type === "label" ? d += "<p>" + b + "</p>" : (s.type === "radio" && (d += "<div>"), s.type === "hidden" ? a += '<input type="hidden" name="' + s.name + '" id="' + s.fieldId + '" value="' + p + '" />' : d += Zn(s.type, s.name, b, s.fieldId, s.required, p, s.default, x, n), s.type === "radio" && (d += "</div>")), o += d, r = s.type;
  }
  return r !== "hidden" && (o += "</div>"), o += a, { html: o, fields: t };
}
function Zn(t, e, n, o, a = false, i, r = null, l = "", c = false) {
  let s = "";
  return (t === "text" || t === "email" || t === "number") && n !== "" && (s += '<label for="' + o + '">' + n + (a ? "<span>*</span>" : "") + "</label>"), s += '<input type="' + t + '"' + (t === "number" ? ' min="0"' : "") + ((t === "checkbox" || t === "radio") && r && (r === "true" || r === true) ? " checked" : "") + ' name="' + e + '" id="' + o + '" placeholder="' + l + '" ' + (c && "disabled") + ' aria-label="' + n + '" value="' + i + '" />', (t === "checkbox" || t === "radio") && (n !== "" || a) && (s += '<label for="' + o + '">' + n + (a ? "<span>*</span>" : "") + "</label>"), s;
}
function he(t, e) {
  let n = true;
  return e.forEach(function(o) {
    if (o.type !== "label" && o.type !== "radio") {
      ...
      if (o.type !== "checkbox") {
        if (a.value = et(a.value.trim()), o.type === "number" && (a.value = a.value.replace(/\D/g, "")), o.type === "email" && a.value !== "" && !gt(a.value)) {
          a.classList.add("error"), n = false;
          return;
        }
      ...
      } else if (o.required && a.checked === false) {
        a.classList.add("error"), n = false;
        return;
      } else
        a.classList.remove("error");
    ...
    if (o.type === "radio") {
      ...
      if (a.forEach(function(r) {
        ...
        a[0].classList.add("error"), n = false;
        return;
      } else
...
async function ge(t, e, n = {}) {
  let o = new FormData(), a = {}, i = {};
  Object.keys(n).length === 0 ? (e.forEach((r) => {
    o.append(r.name, r.value);
  }), i = { method: "POST", body: o }) : (n["Cache-Control"] = "no-cache", n["Content-Type"] = "application/json", n.Accept = "*/*", e.forEach((r) => {
    a[r.name] = r.value;
  }), i = { method: "POST", headers: n, body: JSON.stringify(a) });
  try {
    const r = await fetch(t, i), l = await r.json();
    return r.ok ? l.status && l.status === "doi" ? "doi" : true : (console.error("Network response was not ok"), l.error ? l : false);
  } catch (r) {
    return console.error("Error:", r), false;
  }
}
function lt(t, e, n, o, a = false, i = "", r = false) {
  switch (o) {
    case "trigger":
    case "rsvp":
    default:
      n.id = e.identifier, e.blockInteraction || (n.addEventListener("keyup", function(l) {
        (l.key === "Enter" || l.code == "Space" || l.key === "Alt" && l.key === "Control" && l.code === "Space") && (l.preventDefault(), o === "rsvp" && typeof R == "function" ? R(t, e, n, true) : E(t, "auto", e, n, true, true));
      }), n.addEventListener(
        "touchend",
        P((l) => {
          l.preventDefault(), o === "rsvp" && typeof R == "function" ? R(t, e, n) : E(t, "auto", e, n, false, true);
        })
      ), e.trigger === "click" || o === "rsvp" && typeof R == "function" ? n.addEventListener(
        "mouseup",
        P((l) => {
          l.preventDefault(), o === "rsvp" && typeof R == "function" ? R(t, e, n) : E(t, "auto", e, n, false, true);
        })
      ) : n.addEventListener("mouseenter", function() {
        E(t, "open", e, n, false, true);
      }));
      break;
    case "apple":
    case "google":
    ...
    case "yahoo":
      n.id = e.identifier + "-" + o, e.blockInteraction || (n.addEventListener(
        "click",
        P(async () => {
          r ? (t.querySelector("#" + n.id)?.blur(), z("openSingletonLink", n.id, e.identifier)) : (E(t, "close"), z("openCalendarLink", n.id, e.identifier)), await Q(t, o, e);
        })
      ), n.addEventListener("keyup", async function(l) {
        l.key === "Enter" && (l.preventDefault(), r ? (t.querySelector("#" + n.id)?.blur(), z("openSingletonLink", n.id, e.identifier)) : (E(t, "close"), z("openCalendarLink", n.id, e.identifier)), await Q(t, o, e, "all", true));
      }));
      break;
    case "close":
      n.id = e.identifier + "-close", n.addEventListener(
        "click",
        V(() => {
          z("closeList", "List Close Button", C.active), E(t, "close");
        })
      ), n.addEventListener("keyup", function(l) {
        l.key === "Enter" && (l.preventDefault(), z("closeList", "List Close Button", C.active), E(t, "close", e, "all", true));
      });
      break;
  }
  Hn(e, n, o, a, i, r);
}
function Hn(t, e, n, o, a, i) {
  !t.buttonsList && i && (n = "trigger");
  const r = (function() {
    ...
    return m("label.addtocalendar", t);
  })();
  if (a === "" && (t.options.length === 1 || n === "trigger" ? a = r : n === "close" ? a = m("close", t) : a = m(n, t)), !(t.buttonStyle === "date" && (n === "trigger" || i))) {
    if (e.setAttribute("aria-label", i ? m("label.addtocalendar", t) + " (" + m(n, t) + "): " + t.name : n === "trigger" ? a + ": " + t.name : a), o) {
      const l = document.createElement("div");
      l.classList.add("atcb-icon"), l.setAttribute("part", n === "trigger" ? "atcb-button-icon" : "atcb-list-icon"), l.classList.add(`atcb-icon-${n}`), l.innerHTML = W[`${n}`], e.append(l);
    }
    if ((n === "trigger" || i) && !t.hideTextLabelButton || !i && n !== "trigger" && !t.hideTextLabelList) {
      const l = document.createElement("span");
      l.classList.add("atcb-text"), l.setAttribute("part", n === "trigger" ? "atcb-button-text" : "atcb-list-text"), l.textContent = a, e.append(l);
    }
  }
}
function ve(t, e, n) {
  ...
  (o ? n.options : ["default"]).forEach(function(i, r) {
    const l = document.createElement("div");
    l.classList.add("atcb-button-wrapper"), l.setAttribute("part", "atcb-button-wrapper"), n.rtl && l.classList.add("atcb-rtl"), e.append(l), st(l, n.sizes);
    const c = document.createElement("button");
    if (c.classList.add("atcb-button"), c.setAttribute("part", "atcb-button"), n.disabled && c.setAttribute("disabled", true), n.hideTextLabelButton && c.classList.add("atcb-no-text"), n.trigger === "click" && c.classList.add("atcb-click"), n.listStyle === "overlay" && c.classList.add("atcb-dropoverlay"), c.type = "button", c.setAttribute("aria-expanded", false), l.append(c), n.buttonStyle === "date" && ye(n, c, "all", o), o) {
      c.classList.add("atcb-single");
      const s = (function() {
        return n.buttonsList && n.options.length > 1 ? m(`${n.options[`${r}`]}`, n) : n.label;
      })();
      lt(t, n, c, i, !n.hideIconButton, s, true), c.id = n.identifier, n.buttonsList && (c.id = n.identifier + "-" + i);
    } else {
      lt(t, n, c, "trigger", !n.hideIconButton, n.label);
    ...
    if (!n.hideCheckmark && !n.hideTextLabelButton && !n.buttonsList && !n.disabled && !n.allCancelled) {
      const s = document.createElement("div");
      s.classList.add("atcb-checkmark"), s.innerHTML = W.checkmark, c.append(s);
    }
...
function Fn(t, e) {
  ...
  if (e.options.forEach(function(a) {
    ...
    i.classList.add("atcb-list-item"), i.setAttribute("part", "atcb-list-item"), i.role = "link", i.tabIndex = 0, o++, i.dataset.optionNumber = o, n.append(i), lt(t, e, i, a, !e.hideIconList);
  }), e.listStyle === "modal") {
    const a = document.createElement("div");
    a.classList.add("atcb-list-item", "atcb-list-item-close"), a.setAttribute("part", "atcb-list-item-close"), a.role = "button", a.tabIndex = 0, o++, a.dataset.optionNumber = o, n.append(a), lt(t, e, a, "close", !e.hideIconList);
  }
  return n;
}
function xe(t, e = "", n = false, o = true, a = true) {
  const i = (function() {
    return n ? document.createElement("dialog") : document.createElement("div");
  })();
  if (n && i.setAttribute("open", true), i.id = "atcb-bgoverlay", o || i.classList.add("atcb-no-bg"), i.role = "button", i.tabIndex = 0, a) {
    i.addEventListener(
      "mouseup",
      P((l) => {
        l.target === l.currentTarget && (z("closeList", "Background Hit", C.active), E(t, "close"));
      })
    );
    let r = false;
    i.addEventListener(
      ...
      "touchend",
      V((l) => {
        r !== false || l.target !== l.currentTarget || (z("closeList", "Background Hit", C.active), E(t, "close"));
      }),
      { passive: true }
...
function ct(t, e = true, n = false, o = false) {
  const a = document.createElement("div");
...
async function F(t, e, n = "", o, a = "", i = [], r = [], l = false, c = {}, s = true) {
  C.active = e.identifier;
  const p = !o || o === "" || o === void 0, b = await dt(t, e, false), x = (function() {
    const f = b.getElementById("atcb-bgoverlay");
    if (!f) {
      const L = xe(t, "click", true, !e.hideBackground, s);
      return b.querySelector(".atcb-modal-host-initialized").append(L), L;
    }
    return f;
  })(), d = document.createElement("div");
  d.classList.add("atcb-modal"), x.append(d);
  const h = b.querySelectorAll(".atcb-modal").length;
  d.dataset.modalNr = h, d.tabIndex = 0, d.focus({ preventScroll: true }), d.blur();
  const A = (function() {
    const f = t.getElementById(e.identifier);
    return f || document.getElementById(e.identifier);
  })();
  A && A.classList.add("atcb-active-modal");
  const g = document.createElement("div");
  if (g.classList.add("atcb-modal-box"), g.setAttribute("part", "atcb-modal-box"), e.rtl && g.classList.add("atcb-rtl"), d.append(g), st(g, e.sizes), q(x), n !== "" && !e.hideIconModal) {
    const f = document.createElement("div");
    f.classList.add("atcb-modal-icon"), f.innerHTML = W[`${n}`], g.append(f);
  }
  if (!p) {
    const f = document.createElement("div");
    f.classList.add("atcb-modal-headline"), f.textContent = o, g.append(f);
  }
  if (a !== "") {
    const f = document.createElement("div");
    f.classList.add("atcb-modal-content"), p && f.classList.add("no-headline"), f.innerHTML = a, g.append(f);
  }
  if (e.hideBranding || ct(b, false), r.length > 1) {
    const f = document.createElement("div");
    f.classList.add("atcb-modal-content"), g.append(f);
    const L = document.createElement("div");
    L.classList.add("atcb-modal-content-subevents"), f.append(L);
    for (let u = 1; u < r.length; u++) {
      const T = document.createElement("button");
      T.type = "button", T.id = e.identifier + "-" + r[0] + "-" + u, C[`${e.identifier}`][`${r[0]}`][u - 1] > 0 && T.classList.add("atcb-saved"), T.classList.add("atcb-subevent-btn"), L.append(T), ye(e, T, u, false, true), !e.dates[u - 1].overdue || e.pastDateHandling === "none" ? (u === 1 && l && T.focus(), T.addEventListener(
        "click",
        V(async () => {
          z("openSubEventLink", T.id, e.identifier), T.blur(), await Q(t, r[0], e, r[`${u}`], l, true);
        })
      )) : T.setAttribute("disabled", true);
    }
  }
  i.length === 0 && i.push({ type: "close", label: m("close", e), small: true });
  const y = document.createElement("div");
  y.classList.add("atcb-modal-buttons"), g.append(y), i.forEach((f, L) => {
    let u;
    switch (f.href && f.href !== "" ? (u = document.createElement("a"), u.setAttribute("target", Bt), u.setAttribute("href", f.href), u.setAttribute("rel", "noopener")) : (u = document.createElement("button"), u.type = "button"), f.id && f.id !== "" && (u.id = f.id), u.classList.add("atcb-modal-btn"), f.primary && u.classList.add("atcb-modal-btn-primary"), f.small && u.classList.add("btn-small"), (!f.label || f.label === "") && (f.label = m("modal.button.default", e)), u.textContent = f.label, y.append(u), L === 0 && r.length < 2 && l && u.focus(), f.type) {
      default:
      case "close":
        u.addEventListener(
          "click",
          V(() => {
            z("closeList", "Modal Close Button", C.active), J(t);
          })
        ), u.addEventListener("keyup", function(T) {
          (T.key === "Enter" || T.code == "Space" || T.key === "Alt" && T.key === "Control" && T.code === "Space") && (z("closeList", "Modal Close Button", C.active), E(t, "close", "", "", true));
        });
        break;
      case "yahoo2nd":
        u.addEventListener(
        ...
        ), u.addEventListener("keyup", async function(T) {
          (T.key === "Enter" || T.code == "Space" || T.key === "Alt" && T.key === "Control" && T.code === "Space") && (E(t, "close", "", "", true), await Gt(t, e, l));
        });
        break;
      case "2timeslink":
        u.addEventListener(
          "click",
          V(async () => {
            J(t), await Q(t, c.type, e, c.id, l, false, true);
          })
        ), u.addEventListener("keyup", async function(T) {
          (T.key === "Enter" || T.code == "Space" || T.key === "Alt" && T.key === "Control" && T.code === "Space") && (E(t, "close", "", "", true), await Q(t, c.type, e, c.id, l, false, true));
        });
        break;
      case "none":
        break;
    }
  }), h > 1 && b.querySelector('.atcb-modal[data-modal-nr="' + (h - 1) + '"]').classList.add("atcb-hidden"), Rt(b, d);
}
async function Gt(t, e, n) {
  wt(t, e), await Q(t, "yahoo2nd", e, "all", n);
}
function ye(t, e, n = "all", o = false, a = false) {
  n !== "all" ? n = parseInt(n) - 1 : t.dates.length === 1 && (n = 0);
  const i = eo(t.dates, t.language, n, false, false, a), r = (function() {
    return n !== "all" && t.dates[`${n}`].status.toLowerCase() === "cancelled" || n === "all" && t.allCancelled ? m("date.status.cancelled", t) + "<br>" + m("date.status.cancelled.cta", t) : t.pastDateHandling !== "none" && (n === "all" && t.allOverdue || n !== "all" && t.dates[`${n}`].overdue) ? m("expired", t) : t.label && t.label !== "" ? t.label : m("label.addtocalendar", t);
  })(), l = (function() {
    return n !== "all" && t.dates[`${n}`].status.toLowerCase() === "cancelled" || n === "all" && t.allCancelled ? m("date.status.cancelled", t) : "";
  })(), c = (function() {
    return i.length === 0 ? m("recurring", t) + " &#x27F3;" : "&#x27F3;";
  })();
  let s = false;
  if (n === "all") {
    if (n = 0, !t.allOverdue) {
      for (let v = 0; v < t.dates.length; v++)
        if (!t.dates[`${v}`].overdue) {
          n = v;
          break;
        }
    }
  ...
  const p = new Date(M(t.dates[`${n}`]).start), b = M(t.dates[`${n}`]).allday, x = t.dates[`${n}`].timeZone, d = document.createElement("div");
  d.classList.add("atcb-date-btn-left"), e.append(d);
  const h = document.createElement("div");
  h.classList.add("atcb-date-btn-day"), d.append(h);
  const A = document.createElement("div");
  A.classList.add("atcb-date-btn-month"), h.textContent = p.toLocaleString(t.language, { day: "numeric", timeZone: b ? "UTC" : x }), A.textContent = p.toLocaleString(t.language, { month: "short", timeZone: b ? "UTC" : x }), d.append(A);
  const g = document.createElement("div");
  g.classList.add("atcb-date-btn-right"), e.append(g);
  const y = document.createElement("div");
  y.classList.add("atcb-date-btn-details"), g.append(y);
  const f = document.createElement("div");
  f.classList.add("atcb-date-btn-headline");
  const L = t.dates.length > 1 && s ? t.name : t.dates[`${n}`].name;
  if (f.textContent = L, y.append(f), t.dates[`${n}`].location && t.dates[`${n}`].location !== "" && !t.dates[`${n}`].onlineEvent || l !== "") {
    const v = document.createElement("div");
    if (v.classList.add("atcb-date-btn-content"), y.append(v), l != "")
      v.classList.add("atcb-date-btn-cancelled"), v.textContent = l;
    else {
      const k = document.createElement("span");
      k.classList.add("atcb-date-btn-content-icon"), k.innerHTML = W.location, v.append(k);
      const w = document.createElement("span");
      w.classList.add("atcb-date-btn-content-location"), w.textContent = t.dates[`${n}`].location, v.append(w);
    }
  } else if (t.dates[`${n}`].description !== "" && i.length === 0 && (!t.recurrence || t.recurrence === "")) {
    const v = document.createElement("div");
    v.classList.add("atcb-date-btn-content"), v.textContent = t.dates[`${n}`].descriptionHtmlFree, v.style.overflow = "hidden", v.style.display = "-webkit-box", v.style.webkitLineClamp = "2", v.style.lineClamp = "2", y.append(v);
  } else
    f.style.lineClamp = "2", i.length == 0 && (t.recurrence == null || t.recurrence == "") && (g.style.alignSelf = "center", f.style.textAlign = "center", f.style.lineClamp = "2");
  if (i.length > 0 || t.recurrence != null && t.recurrence != "") {
    const v = document.createElement("div");
    v.classList.add("atcb-date-btn-content"), y.append(v);
    const k = document.createElement("span");
    k.classList.add("atcb-date-btn-content-icon"), k.innerHTML = W.ical, v.append(k);
    const w = document.createElement("span");
    if (w.classList.add("atcb-date-btn-content-text"), v.append(w), i.forEach(function(O) {
      const j = document.createElement("span");
      j.textContent = O, w.append(j);
    }), t.recurrence != null && t.recurrence != "") {
      const O = document.createElement("span");
      O.innerHTML = c, w.append(O);
    }
  }
  const u = document.createElement("div");
  if (u.classList.add("atcb-date-btn-hover"), u.innerHTML = r, g.append(u), !t.hideCheckmark && t.dates[`${n}`].status.toLowerCase() !== "cancelled") {
    const v = document.createElement("div");
    v.classList.add("atcb-checkmark"), v.innerHTML = W.checkmark, e.append(v);
  }
  if (!t.dates[`${n}`].overdue || t.pastDateHandling === "none") {
    const v = document.createElement("div");
    v.classList.add("atcb-date-btn-plus"), v.innerHTML = "+", e.append(v);
  }
  const T = r.replace(/<br>/g, " ").replace(/\+\s/g, "") + (o ? " (" + m(t.options[0], t) + ")" : "") + ": " + L + (t.dates[`${n}`].location && t.dates[`${n}`].location !== "" ? ", " + t.dates[`${n}`].location : "") + ", " + i.join(" ");
  e.setAttribute("aria-label", T);
}
async function dt(t, e, n = true) {
  ...
  a.id = e.identifier + "-modal-host", t.host.hasAttribute("cspnonce") && a.setAttribute("cspnonce", t.host.getAttribute("cspnonce")), a.setAttribute("atcb-button-id", e.identifier), a.classList.add("add-to-calendar"), a.style.transform = "translate3D(0, 0, 0)", a.style.visibility = "visible", a.style.opacity = "1", a.style.position = "fixed", a.style.top = "0", a.style.left = "0", a.style.width = "100%", a.style.height = "100%", a.style.display = "flex", a.style.zIndex = "13999998", document.body.append(a), a.attachShadow({ mode: "open", delegateFocus: true });
  const i = document.createElement("template");
  return i.innerHTML = '<div class="atcb-modal-host-initialized"></div>', a.shadowRoot.append(i.content.cloneNode(true)), Tt(a.shadowRoot, e), await _t(a.shadowRoot, null, e), a.shadowRoot;
}
async function $n(t, e) {
  const n = await dt(t, e);
  return q(n.querySelector(".atcb-modal-host-initialized")), Array.from(t.children).forEach((a) => {
    a.tagName != "STYLE" && n.querySelector(".atcb-modal-host-initialized").append(a.cloneNode(true));
  }), n.querySelector("button.atcb-button").removeAttribute("id"), t.host.classList.add("atcb-shadow-hide"), t.querySelector(".atcb-initialized").style.opacity = "0", ke(t, n), window.addEventListener("scroll", vt), window.addEventListener("resize", vt), n.querySelector(".atcb-modal-host-initialized");
}
function Xn(t, e) {
  ...
  if (t.dates.length > 1) {
    const r = [];
    r.push('"@context":"https://schema.org"'), r.push('"@type":"EventSeries"'), r.push('"@id":"' + o + '"'), r.push('"name":"' + t.name + '",'), a.push(`{\r
` + r.join(`,\r
`) + `\r
`);
  }
  const i = [];
  for (let r = 0; r < t.dates.length; r++) {
    const l = [];
    l.push('"@context":"https://schema.org"'), l.push('"@type":"Event"'), t.dates.length > 1 && l.push('"@id":"' + o + "-" + (r + 1) + '"'), t.dates[`${r}`].status.toLowerCase() === "cancelled" ? l.push('"eventStatus":"https://schema.org/EventCancelled"') : l.push('"eventStatus":"https://schema.org/EventScheduled"'), l.push('"name":"' + t.dates[`${r}`].name + '"'), t.dates[`${r}`].descriptionHtmlFree && l.push('"description":"' + t.dates[`${r}`].descriptionHtmlFree + '"');
    const c = M(t.dates[`${r}`], "delimiters", "general", true);
    if (l.push('"startDate":"' + c.start + '"'), c.duration && l.push('"duration":"' + c.duration + '"'), l.push(t.dates[`${r}`].onlineEvent ? `"eventAttendanceMode":"https://schema.org/OnlineEventAttendanceMode",\r
"location": {\r
"@type":"VirtualLocation",\r
"url":"` + t.dates[`${r}`].location + `"\r
}` : '"location":"' + t.dates[`${r}`].location + '"'), t.recurrence && t.recurrence !== "" ? l.push(...jn(t, c)) : l.push('"endDate":"' + c.end + '"'), t.dates[`${r}`].organizer && t.dates[`${r}`].organizer !== "") {
      const p = t.dates[`${r}`].organizer.split("|");
      l.push(`"organizer":{\r
"@type":"Person",\r
"name":"` + p[0] + `",\r
"email":"` + p[1] + `"\r
    ...
    if (t.images && Array.isArray(t.images))
      for (let p = 0; p < t.images.length; p++)
        nt(t.images[`${p}`], t.debug) && t.images[`${p}`].startsWith("http") && s.push('"' + t.images[`${p}`] + '"');
    s.length > 0 && l.push(`"image":[\r
` + s.join(`,\r
`) + "]"), i.push(`{\r
` + l.join(`,\r
`) + `\r
...
}` : n.textContent = i[0], document.body.insertBefore(n, document.body.firstChild);
}
function jn(t, e) {
  const n = [];
  ...
  if (t.recurrence_byDay && t.recurrence_byDay !== "") {
    const o = (function() {
      ...
      {
        const a = t.recurrence_byDay.split(","), i = {
...
async function Q(t, e, n, o = "all", a = false, i = false, r = false) {
  let l = e;
  if (e === "apple" && (l = "ical"), o !== "all" ? o = parseInt(o) - 1 : n.dates.length == 1 && (o = 0), n.subscribe) {
    await Qn(t, e, l, n, a);
    return;
  }
  if (o !== "all") {
    if (n.dates[`${o}`].status.toLowerCase() === "cancelled" && l !== "ical")
      F(t, n, "warning", m("date.status.cancelled", n), m("date.status.cancelled.cta", n), [], [], a);
    else {
      switch (l) {
        case "ical":
          we(t, n, e, o, a);
      ...
      if (c) {
        const p = c.shadowRoot.getElementById(n.identifier + "-" + e + "-" + (o + 1));
        p && p.classList.add("atcb-saved");
      }
      n.dates[`${o}`].status.toLowerCase() !== "cancelled" && C[`${n.identifier}`][`${e}`][`${o}`]++, C[`${n.identifier}`][`${e}`].filter(function(p) {
        return p < 1;
      }).length == 0 && wt(t, n, i);
    }
    return;
...
function Pn(t, e, n, o, a, i) {
  if (n === "ical" && !o.dates.some((r) => r.status.toLowerCase() === "cancelled") && o.dates.every((r) => (r.organizer || "") === (o.dates[0].organizer || ""))) {
    we(t, o, e, "all", a);
    for (let r = 0; r < C[`${o.identifier}`][`${e}`].length; r++)
      C[`${o.identifier}`][`${e}`][`${r}`]++;
    wt(t, o, i);
    return;
  }
  if (!i) {
    const r = [e];
    for (let l = 0; l < o.dates.length; l++)
      r.push(l + 1);
    F(t, o, e, m("modal.multidate.h", o), m("modal.multidate.text", o), [], r, a);
  }
}
async function Qn(t, e, n, o, a) {
  const i = o.icsFile.replace("https://", "webcal://");
  let r = false;
  switch (n) {
    case "ical":
      if (X() || o.fakeAndroid) {
    ...
    case "yahoo":
      ...
      try {
        await yt(o.icsFile), r = true;
      } catch (l) {
        console.warn(l), r = false;
      }
      F(
        t,
        o,
        "yahoo",
        m("modal.subscribe.yahoo.h", o),
        m("modal.clipboard.text", o) + "<br>" + m("modal.subscribe.yahoo.text", o),
        [
          {
            label: m("modal.subscribe.yahoo.button", o),
            primary: true,
            type: "yahoo2nd",
...
function wt(t, e, n = false) {
  const o = t.getElementById(e.identifier);
  o && o.classList.add("atcb-saved"), Jn(t, e), n && t.querySelectorAll(".atcb-modal[data-modal-nr]").length < 2 && E(t, "close");
}
function Vt(t, e, n, o = null, a = false) {
  if (B() && !Nt()) {
    Te(o, e, t, a);
    return;
  }
...
function Kn(t, e) {
  ...
  let a = false;
  const i = (function() {
    return /^(?:webcal:\/\/|\/\/)calendar\.google\.com\/.*\?cid=/.test(e) ? (a = true, e.replace(/^(.)*\?cid=/, "")) : encodeURIComponent(e);
  })();
  if ((X() || t.fakeAndroid) && a) {
    if (it())
      _(t, "google", n + i, true);
    else {
      const r = n + i, l = encodeURIComponent(r), c = "intent://" + o + i + "#Intent;scheme=https;package=com.google.android.calendar;S.browser_fallback_url=" + l + ";end";
      _(t, "google", c, true);
    }
    return;
  }
...
function Wt(t, e, n, o = "ms365") {
  const a = [], i = (function() {
    return o == "outlookcom" ? "https://outlook.live.com/calendar/0/addfromweb/?" : "https://outlook.office.com/calendar/0/addfromweb/?";
  })();
  a.push("url=" + encodeURIComponent(e)), a.push("name=" + encodeURIComponent(n)), _(t, o, i + a.join("&"), true);
}
function qn(t, e, n = "all") {
  const o = [];
  K() || t.fakeMobile ? o.push("https://calendar.google.com/calendar/render?action=TEMPLATE&") : o.push("https://calendar.google.com/calendar/r/eventedit?");
  const a = M(e, "clean", "google");
  o.push("dates=" + encodeURIComponent(a.start) + "%2F" + encodeURIComponent(a.end)), e.timeZone && e.timeZone !== "" && !/GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|MET|MST|PST8PDT|WET|PST|PDT|MDT|CST|CDT|EDT|EEST|CEST|HST|HDT|AKST|AKDT|AST|ADT|AEST|AEDT|NZST|NZDT|IST|IDT|WEST|ACST|ACDT|BST/i.test(e.timeZone) && !a.allday && o.push("ctz=" + e.timeZone), e.name && e.name !== "" && o.push("text=" + encodeURIComponent(e.name));
  const i = [];
  if (e.description && e.description !== "" && i.push(e.description), e.location && e.location !== "" && (o.push("location=" + encodeURIComponent(e.location)), (B() || t.fakeIOS) && (i.length > 0 && i.push("<br><br>"), i.push("&#128205;: " + e.location))), i.length > 0 && o.push("details=" + encodeURIComponent(i.join(""))), e.recurrence && e.recurrence !== "" && o.push("recur=" + encodeURIComponent(e.recurrence)), e.availability && e.availability !== "") {
    const l = (function() {
  ...
  let r = o.join("&");
  if ((X() || t.fakeAndroid) && !it()) {
    const l = encodeURIComponent(r);
    r = "intent://" + r.slice(8) + "#Intent;scheme=https;package=com.google.android.calendar;S.browser_fallback_url=" + l + ";end";
  }
  _(t, "google", r, false, n);
}
function Gn(t, e, n = "all") {
  const o = [];
  ...
  if (a.allday)
    if (a.start === a.end)
      ...
      i.startTime = "00:00", i.endTime = "23:59", i.timeZone = Intl.DateTimeFormat().resolvedOptions().timeZone;
      const r = M(i, "clean");
      o.push("st=" + encodeURIComponent(r.start) + "&et=" + encodeURIComponent(r.end));
    }
  else
    o.push("st=" + encodeURIComponent(a.start) + "&et=" + encodeURIComponent(a.end));
  e.name && e.name !== "" && o.push("title=" + encodeURIComponent(e.name)), e.location && e.location !== "" && o.push("in_loc=" + encodeURIComponent(e.location)), e.descriptionHtmlFree && e.descriptionHtmlFree !== "" && o.push("desc=" + encodeURIComponent(e.descriptionHtmlFree)), _(t, "yahoo", o.join("&"), false, n);
}
function Jt(t, e, n = "all", o = "ms365") {
  const a = [], i = (function() {
    return K() || t.fakeMobile ? "/calendar/0/deeplink/compose?path=%2Fcalendar%2Faction%2Fcompose&rru=addevent" : "/calendar/0/action/compose?rru=addevent";
  })(), r = (function() {
    return o == "outlookcom" ? "https://outlook.live.com" + i : "https://outlook.office.com" + i;
  })();
  a.push(r);
  const l = M(e, "delimiters", "microsoft");
  a.push("startdt=" + l.start), a.push("enddt=" + l.end), l.allday && a.push("allday=true"), e.name && e.name !== "" && a.push("subject=" + encodeURIComponent(e.name)), e.location && e.location !== "" && a.push("location=" + encodeURIComponent(e.location)), e.description && e.description !== "" && a.push("body=" + encodeURIComponent(e.description)), _(t, o, a.join("&"), false, n);
}
function Vn(t, e, n = "all") {
  const o = [], a = "https://teams.microsoft.com/l/meeting/new?", i = M(e, "delimiters", "msteams", true);
  !i.allday || K() || t.fakeMobile ? (o.push("startTime=" + encodeURIComponent(i.start)), o.push("endTime=" + encodeURIComponent(i.end))) : (o.push("startTime=" + i.start), o.push("endTime=" + i.end)), e.name && e.name !== "" && o.push("subject=" + encodeURIComponent(e.name));
  let r = "";
  e.location && e.location !== "" && (r = e.location, r += " // ", o.push("location=" + encodeURIComponent(r))), e.descriptionHtmlFree && e.descriptionHtmlFree != "" && o.push("content=" + r + encodeURIComponent(e.descriptionHtmlFree)), _(t, "msteams", a + o.join("&"), false, n);
}
function _(t, e, n = "", o = false, a = null, i = "") {
  if (i === "" && (i = Bt), t.proxy && t.proKey && t.proKey !== "") {
    const r = o ? "s" : "o", l = (function() {
      const s = [];
    ...
    if (n = `https://${t.domain ? t.domain : t.dev ? "dev.caldn.net" : "caldn.net"}/${t.proKey}/${r}/${e}${l}`, !nt(n))
      return;
  }
  if (nt(n)) {
    const r = window.open(n, i);
    r && r.focus();
  }
}
function we(t, e, n, o = "all", a = false) {
  o !== "all" && (o = parseInt(o));
  const i = Wn(e, o), r = (function() {
    const d = t.host.getAttribute("attendee") || "", h = t.host.getAttribute("customVar") || "";
    return e.attendee && e.attendee !== "" && d !== "" || e.customVar && e.customVar !== "" && h !== "" ? "" : o !== "all" && e.dates[`${o}`].icsFile && e.dates[`${o}`].icsFile !== "" ? e.dates[`${o}`].icsFile : e.icsFile && e.icsFile !== "" ? e.icsFile : "";
  })();
  if (e.proxy) {
    _(e, n, "", false, o);
    return;
  }
  if (r !== "" && (!B() && !e.fakeIOS || !it() || e.bypassWebViewCheck)) {
    te(r, i);
    return;
  }
  const l = /* @__PURE__ */ new Date(), c = ["BEGIN:VCALENDAR", "VERSION:2.0"];
  c.push("PRODID:-// https://add-to-calendar-pro.com // button v" + be + " //EN"), c.push("CALSCALE:GREGORIAN"), o === "all" ? e.dates[0].organizer && e.dates[0].organizer !== "" ? c.push("METHOD:REQUEST") : c.push("METHOD:PUBLISH") : e.dates[`${o}`].status && e.dates[`${o}`].status.toLowerCase() === "cancelled" ? c.push("METHOD:CANCEL") : e.dates[`${o}`].organizer && e.dates[`${o}`].organizer !== "" ? c.push("METHOD:REQUEST") : c.push("METHOD:PUBLISH");
  const s = [], p = (function() {
    return o != "all" ? o : 0;
  })(), b = (function() {
  ...
  for (let d = p; d <= b; d++) {
    const h = M(e.dates[`${d}`], "clean", "ical"), A = (function() {
      if (h.allday)
        return ";VALUE=DATE";
      if (e.dates[`${d}`].timeZone && e.dates[`${d}`].timeZone !== "") {
        const g = /GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|MET|MST|PST8PDT|WET|PST|PDT|MDT|CST|CDT|EDT|EEST|CEST|HST|HDT|AKST|AKDT|AST|ADT|AEST|AEDT|NZST|NZDT|IST|IDT|WEST|ACST|ACDT|BST/i.test(e.dates[`${d}`].timeZone) ? "GMT" : e.dates[`${d}`].timeZone, y = De(g);
        return s.includes(g) || c.push(y[0]), s.push(g), ";" + y[1];
      }
    })();
    if (c.push("BEGIN:VEVENT"), e.dates[`${d}`].uid && e.dates[`${d}`].uid !== "" && c.push("UID:" + e.dates[`${d}`].uid), c.push("DTSTAMP:" + S(l, "clean", true)), c.push("DTSTART" + A + ":" + h.start), c.push("DTEND" + A + ":" + h.end), c.push("SUMMARY:" + G(e.dates[`${d}`].name)), e.dates[`${d}`].descriptionHtmlFreeICal && e.dates[`${d}`].descriptionHtmlFreeICal !== "" && c.push("DESCRIPTION:" + G(e.dates[`${d}`].descriptionHtmlFreeICal)), e.dates[`${d}`].description && e.dates[`${d}`].description !== "" && c.push(`X-ALT-DESC;FMTTYPE=text/html:\r
 <!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2//EN">\r
 <HTML><BODY>\r
 ` + G(e.dates[`${d}`].description) + `\r
 </BODY></HTML>`), e.dates[`${d}`].location && e.dates[`${d}`].location !== "" && c.push("LOCATION:" + G(e.dates[`${d}`].location)), e.dates[`${d}`].organizer && e.dates[`${d}`].organizer !== "") {
      const g = e.dates[`${d}`].organizer.split("|");
      c.push("ORGANIZER;CN=" + G(g[0], true) + ":MAILTO:" + g[1]);
    }
    if (e.dates[`${d}`].attendee && e.dates[`${d}`].attendee !== "") {
      const g = e.dates[`${d}`].attendee.split("|");
      g.length === 2 ? c.push("ATTENDEE;CUTYPE=INDIVIDUAL;ROLE=REQ-PARTICIPANT;PARTSTAT=ACCEPTED;CN=" + G(g[0], true) + ";X-NUM-GUESTS=0:mailto:" + g[1]) : c.push("ATTENDEE;CUTYPE=INDIVIDUAL;ROLE=REQ-PARTICIPANT;PARTSTAT=ACCEPTED;CN=" + g[0] + ";X-NUM-GUESTS=0:mailto:" + g[0]);
    }
...
async function Te(t, e, n, o) {
  let a = false;
  try {
    await yt(e), a = true;
  } catch (i) {
    console.warn(i), a = false;
  }
  if (B() && !Nt()) {
    F(
      t,
      n,
      "warning",
      m("modal.opensafari.ical.h", n),
      m("modal.opensafari.ical.text", n) + "<br>" + m("modal.clipboard.text", n) + "<br>" + m("modal.opensafari.ical.steps", n),
      [],
      [],
      o
    );
  ...
  F(t, n, "warning", m("modal.webview.ical.h", n), m("modal.webview.ical.text", n) + "<br>" + m("modal.clipboard.text", n) + "<br>" + m("modal.webview.ical.steps", n), [], [], o);
}
function Jn(t, e) {
  z("success", e.identifier, e.identifier), e.ty && typeof Kt == "function" && setTimeout(() => {
    Kt(t, e);
  }, 1e3);
}
function te(t, e) {
  try {
    ...
    n.rel = "noopener", n.href = t, K() ? n.target = "_self" : n.target = "_blank", n.download = e + ".ics";
...
function M(t, e = "delimiters", n = "general", o = false) {
  if (t.startTime && t.startTime !== "" && t.endTime && t.endTime !== "") {
    ...
    const i = /* @__PURE__ */ new Date(t.endDate + "T" + t.endTime + ":00.000+00:00"), r = i - a, l = Math.floor(r / 1e3 / 60 / 60), c = Math.floor((r - l * 60 * 60 * 1e3) / 1e3 / 60 % 60), s = (function() {
      return l < 10 ? "0" + l + ":" + ("0" + c).slice(-2) : l + ":" + ("0" + c).slice(-2);
    })();
    if ((n == "ical" || n == "google") && !/GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|MET|MST|PST8PDT|WET|PST|PDT|MDT|CST|CDT|EDT|EEST|CEST|HST|HDT|AKST|AKDT|AST|ADT|AEST|AEDT|NZST|NZDT|IST|IDT|WEST|ACST|ACDT|BST/i.test(t.timeZone))
      return {
        start: S(a, "clean", true, true),
        end: S(i, "clean", true, true),
        duration: s,
        allday: false
      };
    const p = D(t.timeZone, t.startDate, t.startTime), b = D(t.timeZone, t.endDate, t.endTime);
    if (o) {
      const h = p.slice(0, 3) + ":" + p.slice(3), A = b.slice(0, 3) + ":" + b.slice(3);
      return {
        start: a.toISOString().replace(".000Z", h),
        end: i.toISOString().replace(".000Z", A),
        duration: s,
        allday: false
      };
    }
    const x = parseInt(p[0] + 1) * -1 * ((parseInt(p.substring(1, 3)) * 60 + parseInt(p.substring(3, 5))) * 60 * 1e3), d = parseInt(b[0] + 1) * -1 * ((parseInt(b.substring(1, 3)) * 60 + parseInt(b.substring(3, 5))) * 60 * 1e3);
    return a.setTime(a.getTime() + x), i.setTime(i.getTime() + d), {
      start: S(a, e),
      end: S(i, e),
      duration: s,
      allday: false
    ...
    const a = t.startDate.split("-"), i = t.endDate ? t.endDate.split("-") : a, r = new Date(Date.UTC(a[0], a[1] - 1, a[2], 12, 0, 0)), l = new Date(Date.UTC(i[0], i[1] - 1, i[2], 12, 0, 0));
    if ((n === "google" || n === "microsoft" && !K() || n === "msteams" || n === "ical") && l.setDate(l.getDate() + 1), n === "msteams") {
      if (K()) {
        const c = r.getTimezoneOffset(), s = (function() {
          return c < 0 ? "+" + ("0" + Math.abs(c / 60)).slice(-2) + ":" + ("0" + Math.abs(c % 60)).slice(-2) : "-" + ("0" + Math.abs(c / 60)).slice(-2) + ":" + ("0" + Math.abs(c % 60)).slice(-2);
        })();
        return {
          start: S(r, e, false, true) + "T00:00:00" + s,
          end: S(l, e, false, true) + "T00:00:00" + s,
          allday: true
        };
      }
      return {
        start: S(r, e, false, true) + "+00:00",
        end: S(l, e, false, true) + "+00:00",
        allday: true
      };
    }
    return {
...
function S(t, e = "delimiters", n = true, o = false) {
  const a = (function() {
...
function ee(t, e, n, o) {
  const a = /* @__PURE__ */ new Date(`${t}T${e}:00Z`), i = D(n, t, e), r = new Date(a.getTime() - to(i));
...
function eo(t, e = "en", n = "all", o = false, a = false, i = false, r = false) {
  o && (t = pe({ dates: t }).dates);
  let l, c, s, p, b = {}, x = {}, d = [], h = "", A = "";
  const g = Intl.DateTimeFormat().resolvedOptions().timeZone;
  n === "all" ? (b = M(t[0]), x = M(t[t.length - 1]), s = a ? g : t[0].timeZone, p = a ? g : t[t.length - 1].timeZone) : (b = M(t[`${n}`]), x = b, s = a ? g : t[`${n}`].timeZone, p = s), l = new Date(b.start), c = new Date(x.end), b.allday && (s = "GMT"), x.allday && (p = "GMT");
  const y = ["global", "world-wide", "worldwide", "online"];
  (function() {
    let w = 0, O = t.length - 1;
    for (n != "all" && (w = O = n), w; w <= O; w++)
      if (!(function() {
        return !!(t[`${w}`].location && t[`${w}`].location !== "" && y.includes(t[`${w}`].location.toLowerCase().trim()));
      })() && !t[`${w}`].onlineEvent)
        return false;
    return true;
  })() ? s = p = g : (!b.allday && g !== s && s !== p && (h = "(" + s + ")"), (!x.allday && g !== p || s !== p) && (A = "(" + p + ")"));
  const L = /* @__PURE__ */ new Date(), u = (function() {
    return !i && l.getFullYear() === L.getFullYear();
  })(), T = (function() {
    return !i && c.getFullYear() === L.getFullYear();
  })(), v = ne(s, u, e), k = ne(p, T, e);
  if (l.toLocaleDateString(e, k.DateLong) === c.toLocaleDateString(e, k.DateLong))
    if (b.allday)
      u || d.push(l.toLocaleDateString(e, v.DateLong));
    else {
      let w = "";
      u ? w = l.toLocaleString(e, v.Time) : w = l.toLocaleString(e, v.DateTimeLong), e === "en" && (w = w.replace(/:00/, "")), d.push(w), h !== "" && !r && d.push(h), d.push("-"), w = c.toLocaleTimeString(e, k.Time), e === "en" && (w = w.replace(/:00/, "")), d.push(w), A !== "" && !r && d.push(A);
    }
  else {
    if (b.allday)
      d.push(l.toLocaleDateString(e, v.DateLong));
    else {
      let w = "";
      u ? w = l.toLocaleString(e, v.Time) : w = l.toLocaleString(e, v.DateTimeLong), e === "en" && (w = w.replace(/:00/, "")), d.push(w);
    }
    if (h !== "" && !r && d.push(h), d.push("-"), x.allday)
      d.push(c.toLocaleDateString(e, k.DateLong));
    else {
      let w = c.toLocaleString(e, k.DateTimeLong);
      e === "en" && (w = w.replace(/:00/, "")), d.push(w);
    }
    A !== "" && !r && d.push(A);
  }
  return d;
}
function ne(t, e = false, n = "en") {
...
function nt(t, e = true) {
  return t && t.match(/((\.\.\/)|(\.\.\\)|(%2e%2e%2f)|(%252e%252e%252f)|(%2e%2e\/)|(%252e%252e\/)|(\.\.%2f)|(\.\.%252f)|(%2e%2e%5c)|(%252e%252e%255c)|(%2e%2e\\)|(%252e%252e\\)|(\.\.%5c)|(\.\.%255c)|(\.\.%c0%af)|(\.\.%25c0%25af)|(\.\.%c1%9c)|(\.\.%25c1%259c))/gi) ? (e && console.error("Seems like the generated URL includes at least one security issue and got blocked. Please check the calendar button parameters!"), false) : true;
}
function gt(t) {
  return !!/^.{0,70}@.{1,30}\.[a-z]{2,9}$/i.test(t);
}
function tt(t, e = false, n = false) {
...
function oe(t) {
  ...
  return '<a href="' + e[0] + '" target="' + Bt + '" rel="noopener">' + n + "</a>";
}
...
`), n = [];
  for (let o of e) {
    ...
    const r = [];
    for (; i < o.length; ) {
      const l = o.charAt(i), c = l.charCodeAt(0) >= 55296 && l.charCodeAt(0) <= 56319, s = i > 0 && o.charAt(i - 1) === "\\";
      (a + l).length > 65 && !c && !s && (r.push(a), a = ""), a += l, i++, c && i < o.length && (a += o.charAt(i), i++);
    }
    a.length > 0 && r.push(a), n.push(r[0]);
...
function Ct(t, e, n, o = false, a = false) {
  ...
  const b = t.querySelector("#atcb-reference");
  b && r.classList.contains("atcb-dropup") && (r.parentNode.after(b), b.classList.add("atcb-dropup"));
}
function ke(t, e) {
...
function Rt(t, e = null) {
  (function() {
    if (e != null)
      return e;
    {
      const o = t.querySelectorAll(".atcb-modal");
      return o.length === 0 ? null : o[o.length - 1];
    }
  })() != null && (document.body.classList.add("atcb-modal-no-scroll"), document.documentElement.classList.add("atcb-modal-no-scroll"));
}
function q(t) {
...
function oo(t) {
  const e = t ? t.toString().split(",") : [], n = (i) => {
    switch (i) {
      case "SU":
        return 0;
      case "MO":
  ...
  for (const i of e) {
    const r = i.trim().toUpperCase();
    if (r.length < 2) continue;
    const l = r.slice(-2), c = n(l);
    if (c === void 0) continue;
    const s = r.slice(0, r.length - 2);
    if (s) {
      let p = 1, b = s;
      if (b[0] === "+" ? b = b.slice(1) : b[0] === "-" && (p = -1, b = b.slice(1)), !b || b.length > 2 || !(typeof b == "string" && /^\d+$/.test(b))) continue;
      const d = parseInt(b, 10);
      if (d < 1 || d > 53) continue;
      a.push({ n: p * d, day: c });
    } else
      o.push(c);
  }
  return { plainWeekdays: o, ordinals: a };
}
function Le(t, e = true) {
  const n = t.replace("RRULE:", "").split(";").reduce((o, a) => {
    const [i, r] = a.split("=");
    return o[`${i}`] = r, o;
  }, {});
  if (!n.FREQ) throw new Error("RRULE must have FREQ");
  if (n.FREQ = n.FREQ.toUpperCase(), n.INTERVAL = n.INTERVAL ? parseInt(n.INTERVAL.toString(), 10) : 1, n.COUNT = n.COUNT ? parseInt(n.COUNT.toString(), 10) : null, n.UNTIL) {
    const o = n.UNTIL.toString();
    n.UNTIL = e ? new Date(Date.UTC(parseInt(o.slice(0, 4), 10), parseInt(o.slice(4, 6), 10) - 1, parseInt(o.slice(6, 8), 10), parseInt(o.slice(9, 11) || "0", 10), parseInt(o.slice(11, 13) || "0", 10))) : o;
  }
  if (n.BYWEEKDAY || n.BYDAY) {
    const o = (n.BYWEEKDAY || n.BYDAY)?.toString();
    if (e) {
      const { plainWeekdays: a, ordinals: i } = oo(o);
      n.BYWEEKDAY = a.length ? a : null, n.BYDAY_ORDINALS = i.length ? i : null;
    } else
      n.BYWEEKDAY = n.BYWEEKDAY || n.BYDAY;
  }
  return n.BYMONTH = e && n.BYMONTH ? n.BYMONTH.toString().split(",").map((o) => parseInt(o, 10)) : n.BYMONTH, n.BYYEARDAY = e && n.BYYEARDAY ? n.BYYEARDAY.toString().split(",").map((o) => parseInt(o, 10)) : n.BYYEARDAY, n.BYMONTHDAY = e && n.BYMONTHDAY ? n.BYMONTHDAY.toString().split(",").map((o) => parseInt(o, 10)) : n.BYMONTHDAY, n.BYWEEKNO = e && n.BYWEEKNO ? n.BYWEEKNO.toString().split(",").map((o) => parseInt(o, 10)) : n.BYWEEKNO, n.BYHOUR && delete n.BYHOUR, n;
}
function xt(t) {
  return String(t).padStart(2, "0");
}
function ao(t) {
  if (!t || t === "Z" || t === "+0000" || t === "-0000" || t === "+00:00" || t === "-00:00") return "Z";
  const e = String(t).replace(/^GMT/i, "");
  if (/^[+-]\d{2}:\d{2}$/.test(e)) return e;
  if (/^[+-]\d{4}$/.test(e)) return `${e.slice(0, 3)}:${e.slice(3)}`;
  const n = e.startsWith("-") ? "-" : "+", o = e.replace(/\D/g, "").padStart(4, "0").slice(0, 4);
  return `${n}${o.slice(0, 2)}:${o.slice(2)}`;
}
var re = /* @__PURE__ */ new Map();
function ro(t) {
  const e = t || "UTC", n = re.get(e);
  if (n) return n;
...
function io(t, e) {
  if (!(t instanceof Date) || !isFinite(t.getTime())) return null;
  try {
    const n = ro(e).formatToParts(t), o = (x) => n.find((d) => d.type === x)?.value || "", a = o("weekday");
    let i = null;
    switch (a) {
      case "Sun":
        i = 0;
    ...
    const r = parseInt(o("year"), 10), l = parseInt(o("month"), 10), c = parseInt(o("day"), 10), s = parseInt(o("hour"), 10), p = parseInt(o("minute"), 10), b = parseInt(o("second"), 10);
    return [r, l, c, s, p, b].every((x) => Number.isFinite(x)) ? (i === null && (i = new Date(Date.UTC(r, l - 1, c)).getUTCDay()), { year: r, month: l, day: c, hour: s, minute: p, second: b, weekday: i }) : null;
  } catch {
    return null;
  }
}
...
function Ce(t, e, n) {
  const o = Date.UTC(t, 0, 1), a = Date.UTC(t, e, n);
  return Math.floor((a - o) / 864e5) + 1;
}
function co(t, e, n) {
  const o = new Date(Date.UTC(t, e, n));
  o.setUTCDate(o.getUTCDate() + 4 - (o.getUTCDay() || 7));
  const a = new Date(Date.UTC(o.getUTCFullYear(), 0, 1));
  return Math.ceil(((o.getTime() - a.getTime()) / 864e5 + 1) / 7);
}
function so(t) {
  const e = t.month - 1;
  return {
    ...t,
    month0: e,
    dayOfYear: Ce(t.year, e, t.day),
    weekNumber: co(t.year, e, t.day)
  };
}
function $(t, e) {
  const n = e ? io(t, e) : null;
  return so(n || lo(t));
}
function bo(t, e, n, o, a = null) {
  const i = a || $(t, n), r = Number.isFinite(i.month0) ? i.month0 : Number.isFinite(i.month) ? i.month - 1 : 0, l = Date.UTC(i.year, r, i.day) + e * 864e5, c = new Date(l), s = `${c.getUTCFullYear()}-${xt(c.getUTCMonth() + 1)}-${xt(c.getUTCDate())}`, p = n || "UTC";
  try {
    const b = D(p, s, o);
    return /* @__PURE__ */ new Date(`${s}T${o}:00${ao(b)}`);
  } catch {
    return new Date(t.getTime() + e * 864e5);
  }
}
function po(t, e, n, o, a, i) {
  const r = parseInt(e.INTERVAL.toString(), 10) || 1, l = a || $(t, o), c = i || $(n, o);
  switch (e.FREQ) {
    case "YEARLY":
      return (l.year - c.year) % r === 0;
    case "MONTHLY":
      return ((l.year - c.year) * 12 + (l.month0 - c.month0)) % r === 0;
    case "WEEKLY": {
      const s = Math.floor((Date.UTC(l.year, l.month0, l.day) - Date.UTC(c.year, c.month0, c.day)) / 864e5);
      return Math.floor(s / 7) % r === 0;
    }
    case "DAILY":
      return Math.floor((Date.UTC(l.year, l.month0, l.day) - Date.UTC(c.year, c.month0, c.day)) / 864e5) % r === 0;
    default:
      return true;
  }
}
function uo(t, e, n, o, a, i) {
  return !(!mo(t, e, o, a) || !fo(t, e, n, o, a, i));
}
function mo(t, e, n, o) {
  const a = o || $(t, n);
  if (e.BYMONTH && !e.BYMONTH.includes(a.month) || e.BYYEARDAY && !e.BYYEARDAY.includes(a.dayOfYear) || e.BYMONTHDAY && !e.BYMONTHDAY.includes(a.day) || e.BYWEEKNO && !e.BYWEEKNO.includes(a.weekNumber)) return false;
  const r = !!(e.BYWEEKDAY && e.BYWEEKDAY.length) ? e.BYWEEKDAY.includes(a.weekday) : null;
  let l = null;
  if (e.BYDAY_ORDINALS && Array.isArray(e.BYDAY_ORDINALS) && e.BYDAY_ORDINALS.length > 0) {
    const c = a.weekday, s = a.year, p = a.month0, b = a.dayOfYear, x = new Date(Date.UTC(s, p + 1, 0)).getUTCDate(), d = Ce(s, 11, 31), h = (y, f) => {
      if (y === 0) return false;
      if (y > 0) {
        const u = new Date(Date.UTC(s, p, 1)).getUTCDay(), v = 1 + (f - u + 7) % 7 + (y - 1) * 7;
        return v >= 1 && v <= x && a.day === v;
      } else {
        const L = new Date(Date.UTC(s, p + 1, 0)), T = (L.getUTCDay() - f + 7) % 7, v = L.getUTCDate() - T + (y + 1) * 7;
        return v >= 1 && v <= x && a.day === v;
      }
    }, A = (y, f) => {
      if (y === 0) return false;
      if (y > 0) {
        const u = new Date(Date.UTC(s, 0, 1)).getUTCDay(), v = 1 + (f - u + 7) % 7 + (y - 1) * 7;
        return v >= 1 && v <= d && b === v;
      } else {
        const T = (new Date(Date.UTC(s, 11, 31)).getUTCDay() - f + 7) % 7, v = d - T + (y + 1) * 7;
        return v >= 1 && v <= d && b === v;
      }
    };
    l = e.BYDAY_ORDINALS.some(({ n: y, day: f }) => f !== c ? false : e.FREQ === "MONTHLY" ? h(y, f) : e.FREQ === "YEARLY" ? e.BYMONTH && e.BYMONTH.length > 0 ? h(y, f) : e.BYWEEKNO ? false : A(y, f) : false);
  }
  return !(r === false && l === false || r === false && l === null || l === false && r === null);
}
function fo(t, e, n, o, a, i) {
  const r = a || $(t, o), l = i || $(n, o);
  if (r.hour !== l.hour) return false;
  const c = !!(e.BYWEEKDAY && e.BYWEEKDAY.length) || !!(e.BYDAY_ORDINALS && e.BYDAY_ORDINALS.length);
  return !(e.FREQ === "WEEKLY" && !c && r.weekday !== l.weekday || e.FREQ === "MONTHLY" && !e.BYMONTHDAY && !c && r.day !== l.day || e.FREQ === "YEARLY" && !e.BYMONTH && r.month0 !== l.month0 || e.FREQ === "YEARLY" && !e.BYMONTHDAY && !c && !e.BYYEARDAY && !e.BYWEEKNO && r.day !== l.day);
}
function ho(t, e, n, o, a = "UTC") {
  const i = Le(t), r = $(e, a), l = `${xt(r.hour)}:${xt(r.minute)}`;
  if (o && i.UNTIL instanceof Date) {
    const g = new Date(i.UNTIL);
    g.setUTCHours(23, 59, 59, 999), i.UNTIL = g;
  }
  const c = /* @__PURE__ */ new Date(), s = new Date(c.getTime() - n);
  let p = e;
  const b = [];
  let x = 0, d = 1e4;
  for (; !(i.UNTIL && p > i.UNTIL); ) {
    const g = $(p, a);
    if (po(p, i, e, a, g, r) && uo(p, i, e, a, g, r) && (b.push(p), x++, i.COUNT && x >= i.COUNT || !i.COUNT && !i.UNTIL && (o ? p >= s : p > s)) || --d <= 0)
      break;
    p = bo(p, 1, a, l, g);
  }
  let h = null, A = 0;
  ...
  return h || (b.length > 1 ? (h = b[b.length - 1], A = A - 1) : b.length === 1 ? h = b[0] : (h = e, A = 1)), {
    nextOccurrence: h,
    adjustedCount: i.COUNT ? i.COUNT - A : x - A
  };
}
function go(t) {
  return t && {
...
async function yt(t) {
  ...
  if (!e) throw new Error("No value to copy!");
  const n = () => {
    if (typeof window > "u" || typeof document > "u" || !document.queryCommandSupported || !document.queryCommandSupported("copy")) return false;
    const a = document.createElement("textarea"), i = document.activeElement;
    a.value = e, a.setAttribute("readonly", ""), a.style.contain = "strict", a.style.position = "fixed", a.style.top = "-9999px", a.style.left = "-9999px", a.style.opacity = "0", a.style.outline = "none", a.style.pointerEvents = "none", a.style.fontSize = "12pt", document.body.appendChild(a);
    try {
      a.focus(), a.select(), B() && (a.selectionStart = 0, a.selectionEnd = e.length);
      const r = document.execCommand("copy");
      return document.body.removeChild(a), i && typeof i.focus == "function" && i.focus(), r;
    } catch {
      return document.body.removeChild(a), i && typeof i.focus == "function" && i.focus(), false;
    }
  };
  if ((() => {
    try {
      return !!(typeof window < "u" && "isSecureContext" in window && window.isSecureContext || typeof window < "u" && window.location && window.location.protocol === "https:" || typeof window < "u" && window.location && (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1"));
    } catch {
      return false;
    }
    ...
    try {
      if (typeof window < "u" && typeof window.ClipboardItem < "u" && typeof navigator.clipboard.write == "function") {
        const a = "text/plain", i = new Blob([e], { type: a }), r = [new ClipboardItem({ [a]: i })];
        return await navigator.clipboard.write(r), "Copied!";
      }
    } catch {
    }
  }
...
function z(t, e, n) {
  ...
  o && o.setAttribute("atcb-last-event", t + ":" + e), U() && vo(t, e);
}
function vo(t, e) {
  let n = "";
  switch (t) {
...
var yo = Object.keys(It);
function m(t, e) {
  return e.customLabels && e.customLabels[`${t}`] && e.customLabels[`${t}`] !== "" ? tt(e.customLabels[`${t}`]) : Ye(t, e.language);
}
function Ye(t, e) {
  return e || (e = "en"), It[`${e}`][`${t}`] ? It[`${e}`][`${t}`] : e !== "en" ? Ye(t, "en") : t;
}
var St = false;
var ft = 0;
var rt = [];
var Dt = '<div class="atcb-initialized atcb-hidden"></div>';
if (U()) {
  class t extends HTMLElement {
    constructor() {
      super(), this._initialized = new Promise((o) => this._initializedResolver = o);
      const n = document.createElement("template");
      n.innerHTML = Dt, this.attachShadow({ mode: "open", delegateFocus: true }), this.shadowRoot.append(n.content.cloneNode(true)), this.state = {
        initializing: false,
        initialized: false,
        ready: false,
        updatePending: false
      }, this.data = {}, this.error = false;
    }
    connectedCallback() {
      this.initializing || (this.initializing = true, setTimeout(() => this.initializeComponent(), 0));
    }
    async initializeComponent() {
      ...
      try {
        this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" || this.hasAttribute("prokey") && this.getAttribute("prokey") !== "" ? (this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" ? this.data = await at(this.getAttribute("proKey"), this) : this.data = await at(this.getAttribute("prokey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : (this.data.proKey = "", this.data = await ie(this, this.debug));
      } catch (o) {
        this.debug && (console.error(o), Yt(this.shadowRoot, o)), this.error = true, this.state.initializing = false, this.state.ready = true, this._initializedResolver();
        return;
      }
      await this.initButton(), this.state.initializing = false, this.state.initialized = true, this.state.ready = true, this._initializedResolver();
    }
    whenInitialized() {
      return this._initialized;
    }
    disconnectedCallback() {
      le(this.shadowRoot, this.identifier), this.debug && console.log('Add to Calendar Button "' + this.identifier + '" destroyed'), document.querySelectorAll("add-to-calendar-button").length === 0 && (ft = 0);
    }
    static get observedAttributes() {
      const n = ["instance", "prokey", "proKey", "prooverride", "proOverride"];
      return this.proKey && this.proKey !== "" ? zt.map((o) => o.toLowerCase()).concat(n) : ht.map((o) => o.toLowerCase()).concat(n);
    }
    attributeChangedCallback(n, o, a) {
      this.state.ready && (this.debug && this.state.initialized && console.log(`${n}'s value has been changed from ${o} to ${a}`), this.updatePending || (this.updatePending = true, setTimeout(() => this.updateComponent(), 0)));
    }
    async updateComponent() {
      if (!this.updatePending) return;
      this.data = {}, this.shadowRoot.querySelector(".atcb-initialized").remove();
      const n = document.createElement("template");
      n.innerHTML = Dt, this.shadowRoot.append(n.content.cloneNode(true));
      try {
        this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" ? (this.data = await at(this.getAttribute("proKey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : this.hasAttribute("prokey") && this.getAttribute("prokey") !== "" ? (this.data = await at(this.getAttribute("prokey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : this.data = await ie(this, this.debug);
      } catch (o) {
        this.debug && (console.error(o), Yt(this.shadowRoot, o)), this.updatePending = false;
        return;
      }
      le(this.shadowRoot, this.identifier), await this.initButton(), this.updatePending = false;
    }
    async initButton() {
      if (this.state.initialized || (ft = ft + 1), this.identifier && this.identifier !== "")
        ...
        (this.data.identifier == null || this.data.identifier == "") && (this.data.identifier = "atcb-btn-" + ft), this.identifier = this.data.identifier;
      }
      this.setAttribute("atcb-button-id", this.data.identifier);
      try {
        return this.style.visibility = "visible", this.style.opacity = "1", this.style.position = "relative", this.style.outline = "none", await wo(this.shadowRoot, this.data), true;
      } catch (n) {
        return this.debug && (console.error(n.message ? n.message : n), Yt(this.shadowRoot, n)), false;
      }
    }
  }
  customElements.get("add-to-calendar-button") || customElements.define("add-to-calendar-button", t);
}
async function ie(t, e = false) {
  let n;
  try {
    n = ze(t), await Ot(n);
  } catch {
    ...
    try {
      const a = JSON.parse(et(o.replace(/(\r\n|\n|\r)/g, ""), false));
      await Ot(a), n = a;
    } catch (a) {
...
function ze(t, e = ht) {
  ...
  for (let o = 0; o < e.length; o++) {
    let a = e[`${o}`];
    if (t.hasAttribute(`${a}`)) {
      let i = et(t.getAttribute(`${a}`).replace(/(\\r\\n|\\n|\\r)/g, ""), false), r;
      if (Et.includes(a))
        r = !i || i === "" || i.toLowerCase() === "true";
      else if (Ze.includes(a)) {
        const l = (function() {
          return !i || i === "" ? "{}" : i.substring(0, 1) != "{" ? "{" + i + "}" : i;
        })();
        r = JSON.parse(l);
      } else if (He.includes(a)) {
        const l = (function() {
          return !i || i === "" ? "[]" : i.substring(0, 1) != "[" ? "[" + i + "]" : i;
        })();
        r = JSON.parse(l);
      } else Fe.includes(a) ? (r = i, i.includes("[") && (r = r.substring(1, r.length - 1)), (i.includes('"') || i.includes("'")) && (r = r.substring(1, r.length - 1)), i.includes("|") || (r = r.replace(/\s/g, "")), r.includes("','") ? r = r.split("','") : r = r.split('","')) : $e.includes(a) ? r = parseInt(i) : r = i;
      if (typeof r == "object" && Object.keys(r).length === 0 || Array.isArray(r) && (r.length === 0 || r.length === 1 && r[0] === ""))
        continue;
      n[`${a}`] = r;
    }
  }
...
async function wo(t, e) {
  try {
    t.host.classList.add("add-to-calendar"), e = await Mt(e), await ue(e);
    const n = t.querySelector(".atcb-initialized");
    return Tt(t, e), n.setAttribute("lang", e.language), _t(t, n, e), Oe(e), Se(t, e), Ie(e.proKey, e.hideBranding, e.debug), e.hidden || (typeof R == "function" && e.rsvp && Object.keys(e.rsvp).length > 0 ? e.inlineRsvp ? await R(t, e, n) : await Un(t, e) : ve(t, n, e), !e.hideRichData && !e.subscribe && e.name && e.dates[0].location && e.dates[0].startDate && Xn(e, t.host)), z("initialization", e.identifier, e.identifier), !e.proKey && e.hideBranding && !document.getElementById("atcb-reference") && ct(document.body, false, false, true), true;
  } catch (n) {
    throw new Error(n.message);
  }
}
function le(t, e) {
  ...
  n && n.remove(), Array.from(t.querySelectorAll(".atcb-debug-error-msg")).concat(Array.from(t.querySelectorAll("style"))).concat(Array.from(t.querySelectorAll("link"))).concat(Array.from(t.querySelectorAll(".atcb-placeholder"))).concat(Array.from(t.querySelectorAll(".atcb-button-wrapper"))).forEach((o) => o.remove()), delete C[`${e}`];
}
function Tt(t, e) {
...
async function _t(t, e = null, n) {
  ...
  const a = document.createElement("style"), i = n.inlineRsvp && n.rsvp && Object.keys(n.rsvp).length > 0 ? "100%" : "fit-content";
  a.innerText = `.atcb-initialized { display: block; position: relative; width: ${i}; }.atcb-initialized.atcb-inline { display: inline-block; }.atcb-initialized.atcb-buttons-list { display: flex; flex-wrap: wrap; justify-content: center; gap: var(--buttonslist-gap); }.atcb-hidden { display: none; }`, o && a.setAttribute("nonce", o), t.prepend(a);
  const r = (function() {
    return n.styleLight ? ":host{" + et(n.styleLight.replace(/(\\r\\n|\\n|\\r)/g, ""), false) + "}" : "";
  })(), l = (function() {
    return n.styleDark ? ":host(.atcb-dark){" + et(n.styleDark.replace(/(\\r\\n|\\n|\\r)/g, ""), false) + "}" : "";
  })();
  if (n.customCss && n.customCss !== "") {
    ...
    if (c.setAttribute("rel", "stylesheet"), c.setAttribute("type", "text/css"), c.setAttribute("href", n.customCss), o && c.setAttribute("nonce", o), !e)
      await ce(c, t, null, o, null, false, false, r + l);
    else {
      const s = document.createElement("div");
      s.classList.add("atcb-placeholder"), t.prepend(s);
      const p = document.createElement("style");
      p.innerText = ".atcb-placeholder { background-color: #777; border-radius: 200px; height: 40px; opacity: .3; width: 150px; }", o && p.setAttribute("nonce", o), t.prepend(p), ce(c, t, e, o, s, n.inline, n.buttonsList, r + l);
    }
    return;
  }
  if (n.buttonStyle !== "none" && $t[`${n.buttonStyle}`]) {
    const c = document.createElement("style");
    o && c.setAttribute("nonce", o), c.innerText = $t[`${n.buttonStyle}`] + r + l, t.prepend(c);
  }
...
async function ce(t, e, n = null, o = null, a = null, i = false, r = false, l = "") {
  if (l !== "") {
    const c = document.createElement("style");
    c.innerText = l, o && c.setAttribute("nonce", o), e.prepend(c);
  }
  try {
    e.prepend(t), await new Promise((c) => {
      t.onload = c;
    }), n && (a && a.remove(), i ? (n.style.display = "inline-block", n.classList.add("atcb-inline")) : r && n.classList.add("atcb-buttons-list"), n.classList.remove("atcb-hidden"));
  } catch (c) {
    console.log(c);
  }
}
function Yt(t, e) {
  ...
  const n = Ee(t), o = document.createElement("div");
...
async function Yo(t, e, n = false) {
  ...
  try {
    o = await (async function() {
      const l = et(t);
      if (l.prokey && l.prokey !== "" && (l.proKey = l.prokey), l.proKey && l.proKey !== "")
        try {
          return await at(l.proKey, null, l);
        } catch (c) {
  ...
  try {
    ...
    throw o.debug && console.error(l), new Error("Add to Calendar Button generation failed: no data provided or missing required fields - see console logs for details");
  }
  o = await Mt(o);
  let a = document.body;
  ...
  try {
    ...
    return console.error(l), false;
  }
  const i = (function() {
    return o.options.length === 1;
  })(), r = document.getElementById("atcb-customTrigger-" + o.identifier + "-host");
  if (r && (J(r.shadowRoot, false), C[`${C.active}`] && delete C[`${C.active}`], r.remove()), z("initialization", o.identifier, o.identifier), !o.blockInteraction && !o.hidden) {
    const l = document.createElement("div");
    if (o.cspnonce && o.cspnonce !== "" && l.setAttribute("cspnonce", o.cspnonce), l.id = "atcb-customTrigger-" + o.identifier + "-host", a === document.body ? document.body.append(l) : a.after(l), e) {
      const p = e.getBoundingClientRect();
      l.style.position = "relative", l.style.left = -p.width + "px", l.style.top = p.height + "px";
    }
    l.setAttribute("atcb-button-id", o.identifier), l.attachShadow({ mode: "open", delegateFocus: true });
    const c = document.createElement("template");
    c.innerHTML = Dt, l.shadowRoot.append(c.content.cloneNode(true));
    const s = l.shadowRoot.querySelector(".atcb-initialized");
    Oe(o), Tt(l.shadowRoot, o), l.shadowRoot.querySelector(".atcb-initialized").setAttribute("lang", o.language), _t(l.shadowRoot, s, o), Se(l.shadowRoot, o), typeof R == "function" && o.rsvp && Object.keys(o.rsvp).length > 0 ? R(l.shadowRoot, o, e, n) : i ? (await Q(l.shadowRoot, o.options[0], o, "all", n), z("openSingletonLink", o.identifier, o.identifier)) : E(l.shadowRoot, "open", o, e, n);
  }
  return Ie(o.proKey, o.hideBranding, o.debug), o.debug && console.log('Add to Calendar Button "' + o.identifier + '" triggered'), o.identifier;
}
function Oe(t) {
  const e = [];
...
function Ie(t = "", e = false, n = false) {
  if (!St) {
    const o = (function() {
      return n ? " (version " + be + ")" : "";
    })();
    t !== "" ? (!e || n) && console.log("Add to Calendar PRO script initialized" + o + " | https://add-to-calendar-pro.com") : (console.log(`%c
Add to Calendar Button script initialized` + o + `
see https://add-to-calendar-button.com for details.
`, "font-weight: bold;"), console.log("✨ %cPRO version available at https://add-to-calendar-pro.com ← check it out!", "font-weight: bold; line-height: 60px;")), St = true;
  }
}
async function at(t, e = null, n = {}) {
  if (t && t !== "")
    try {
      const o = e ? e.proOverride : n.proOverride, a = e ? ze(e, o ? ht : zt) : n, i = await fetch(`https://${a.dev ? "event-dev.caldn.net" : "event.caldn.net"}/${t}/config.json`);
      if (i.ok) {
        const r = await i.json();
        if (o) {
          const c = (window.location.hostname || "").split(".").slice(-2).join(".");
          ht.forEach((s) => {
            Object.prototype.hasOwnProperty.call(a, s) && (["hideBranding", "ty", "rsvp"].indexOf(s) === -1 || c === "caldn.net" || c === "add-to-calendar-pro.com") && (r[`${s}`] = a[`${s}`]);
          });
        } else
          zt.forEach((l) => {
            Object.prototype.hasOwnProperty.call(a, l) && (r[`${l}`] = a[`${l}`]);
          });
        if (a.rsvp && Object.prototype.hasOwnProperty.call(a.rsvp, "none") && delete r.rsvp, (!r.name || r.name === "") && (!r.dates || r.dates[0].name === ""))
          throw new Error("Not possible to read proKey config from server...");
        if (r.landingpage.domain && r.landingpage.domain !== "" && nt(r.landingpage.domain) && (r.domain = r.landingpage.domain, delete r.landingpage), (!r.proxy || r.proxy === "") && (!r.hideBranding || r.hideBranding === "")) {
          for (let l = 0; l < r.dates.length; l++)
            r.dates[`${l}`].description && r.dates[`${l}`].description !== "" ? r.dates[`${l}`].description += "[br][br][p]Powered by add-to-calendar-pro.com[/p]" : r.dates[`${l}`].description = "Powered by add-to-calendar-pro.com";
          r.description && r.description !== "" && (r.description += "Powered by add-to-calendar-pro.com");
        }
        return r.proKey = t, r.identifier = t, r;
      }
      throw new Error("Not possible to read proKey config from server...");
    } catch (o) {
      throw console.error(o), new Error("proKey invalid or server not responding!");
    }
  return {};
}
function Se(t, e) {
  U() && (e.lightMode == "bodyScheme" && (rt[e.identifier] = new MutationObserver(function(n) {
    n.forEach((o) => {
      o.attributeName === "class" && Tt(t, e);
    });
  }), rt[e.identifier].observe(document.documentElement, { attributes: true }), rt[e.identifier].observe(document.body, { attributes: true })), St || (document.addEventListener("keyup", To), document.addEventListener("keydown", ko), window.addEventListener("resize", Ao)));
}
function To(t) {
  const e = (function() {
    const n = document.querySelector('[atcb-button-id="' + C.active + '"]');
    return n ? n.shadowRoot : null;
  })();
  e && t.key === "Escape" && (z("closeList", "Ecs Hit", C.active), E(e, "close", "", "", true));
}
function ko(t) {
  const e = (function() {
    const n = document.querySelector('[atcb-button-id="' + C.active + '"]'), o = document.getElementById(C.active + "-modal-host");
  ...
  if (e && e.querySelector(".atcb-list") && (t.key === "ArrowDown" || t.key === "ArrowUp" || t.key === "Tab")) {
    ...
    o && o.classList.contains("atcb-list-item") ? (t.key === "ArrowDown" && o.dataset.optionNumber < a ? n = parseInt(o.dataset.optionNumber) + 1 : t.key === "Tab" ? t.shiftKey ? o.dataset.optionNumber > 1 ? n = parseInt(o.dataset.optionNumber) - 1 : n = a : o.dataset.optionNumber < a ? n = parseInt(o.dataset.optionNumber) + 1 : n = 1 : t.key === "ArrowUp" && o.dataset.optionNumber >= 1 && (n = parseInt(o.dataset.optionNumber) - 1), n > 0 && e.querySelector('.atcb-list-item[data-option-number="' + n + '"]').focus()) : t.key === "ArrowUp" ? e.querySelector('.atcb-list-item[data-option-number="' + a + '"]').focus() : e.querySelector('.atcb-list-item[data-option-number="1"]').focus();
  }
}
function Ao() {
  const t = (function() {
    const e = document.querySelector('[atcb-button-id="' + C.active + '"]'), n = document.getElementById(C.active + "-modal-host");
...
function Lo(t) {
  typeof rt[`${t}`] < "u" && rt[`${t}`].disconnect();
}
var zo = (t) => {
  const e = import_react.default.useMemo(() => {
    const n = {};
    for (const [o, a] of Object.entries(t)) {
      let i = a;
      typeof a != "string" && typeof a != "boolean" && (i = JSON.stringify(a)), Object.assign(n, { [o]: i });
    }
    return n;
  }, [t]);
  return import_react.default.createElement("add-to-calendar-button", { ...e });
};
export {
  zo as AddToCalendarButton,
  Yo as atcb_action
};
//# sourceMappingURL=add-to-calendar-button-react.js.map
